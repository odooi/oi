...
term representation was ['=', 'company_id.name', 'Oi']. Used in a
...
Oi will use the SQL function 'unaccent' when available for the
...
Finally, to instruct Oi to really use the unaccent function, you have to
...
import oi.modules
from oi.models import check_property_field_value_name, READ_GROUP_NUMBER_GRANULARITY
from oi.tools import Query, SQL, get_lang
from oi.tools.sql import pattern_to_translated_trigram_pattern, value_to_translated_trigram_pattern
...
def get_unaccent_wrapper(cr):
    ...
    return oi.modules.registry.Registry(cr.dbname).unaccent
