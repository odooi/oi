...
import oi
from oi import api, fields, models, modules, tools, _
from oi.addons.base.models.ir_model import MODULE_UNINSTALL_FLAG
from oi.exceptions import AccessDenied, UserError, ValidationError
from oi.osv import expression
from oi.tools.parse_version import parse_version
from oi.tools.misc import topological_sort, get_flag
from oi.tools.translate import TranslationImporter, get_po_paths
from oi.http import request
from oi.modules import get_module_path
...
class Module(models.Model):
                ...
                with tools.file_open(path, 'rb') as desc_file:
                    ...
                    if doc.startswith(XML_DECLARATION):
                        warnings.warn(
                            ...
                            f"deprecated since Oi 17, {module.name} can just "
                        ...
                        try:
                            ...
                            warnings.warn(
                                ...
                                f"since Oi 17 ({module.name}'s description "
                                f"is not utf-8)",
                                category=DeprecationWarning,
                            )
    ...
    license = fields.Selection([
        ...
        ('OEEL-1', 'Oi Plus Edition License v1.0'),
        ('OPL-1', 'Oi Proprietary License v1.0'),
    ...
    to_buy = fields.Boolean('Oi Plus Module', default=False)
    ...
    def _button_immediate_function(self, function):
        ...
        try:
            ...
            raise UserError(_("Oi is currently processing a scheduled action.\n"
    ...
    def button_uninstall(self):
        un_installable_modules = set(oi.conf.server_wide_modules) & set(self.mapped('name'))
