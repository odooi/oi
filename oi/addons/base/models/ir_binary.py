...
from oi.exceptions import MissingError, UserError
from oi.http import Stream, request
from oi.tools import file_open, replace_exceptions
from oi.tools.image import image_process, image_guess_size_from_field_name
from oi.tools.mimetypes import guess_mimetype, get_extension
from oi.tools.misc import verify_limited_field_access_token
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:oi.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~oi.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`oi.tools.image.image_process`.
