...
import oi
from oi import api, http, models, tools, SUPERUSER_ID
from oi.exceptions import AccessDenied
from oi.http import request, Response, ROUTING_KEYS
from oi.modules.registry import Registry
from oi.service import security
from oi.tools.json import json_default
from oi.tools.misc import get_lang, submap
from oi.tools.translate import code_translations

_logger = logging.getLogger(__name__)

# see also mimetypes module: https://docs.python.org/3/library/mimetypes.html and oi.tools.mimetypes
...
class IrHttp(models.AbstractModel):
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        for key, val in list(args.items()):
            ...
            try:
            ...
            except (oi.exceptions.AccessError, oi.exceptions.MissingError) as e:
                ...
                if isinstance(e, oi.exceptions.MissingError):
    ...
    def routing_map(self, key=None):
        ...
        installed = registry._init_modules.union(oi.conf.server_wide_modules)
    ...
    def _gc_sessions(self):
        if os.getenv("OI_SKIP_GC_SESSIONS"):
            return
