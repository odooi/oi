...
from oi import api, fields, models, SUPERUSER_ID, tools, _
from oi.exceptions import AccessError, ValidationError, UserError
from oi.http import Stream, root, request
from oi.tools import config, human_size, image, str2bool, consteq
from oi.tools.mimetypes import guess_mimetype, fix_filename_extension
...
class IrAttachment(models.Model):
    """Attachments are used to link binary files or url to any oi document.
