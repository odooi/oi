...
QWeb is the primary templating engine used by Oi. It is an XML templating
...
<https://www.odoodooi.com/documentation/master/developer/reference/frontend/qweb.html>`
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
**Values**: name of the allowed oi user group, or preceded by ``!`` for
prohibited groups

The generated code uses ``has_group`` Oi method from ``res.users`` model.
...
from oi import api, models, tools
from oi.modules import registry
from oi.tools import config, safe_eval, pycompat
from oi.tools.constants import SUPPORTED_DEBUGGER, EXTERNAL_ASSET
from oi.tools.safe_eval import assert_valid_codeobj, _BUILTINS, to_opcodes, _EXPR_OPCODES, _BLACKLIST
from oi.tools.json import scriptsafe
from oi.tools.lru import LRU
from oi.tools.misc import str2bool
from oi.tools.image import image_data_uri, FILETYPE_BASE64_MAGICWORD
from oi.http import request
from oi.tools.profiler import QwebTracker
from oi.exceptions import UserError, AccessDenied, AccessError, MissingError, ValidationError

from oi.addons.base.models.assetsbundle import AssetsBundle
from oi.tools.constants import SCRIPT_EXTENSIONS, STYLE_EXTENSIONS, TEMPLATE_EXTENSIONS
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since Oi 17.0, keep the value empty and configure the "
    ...
    def _link_to_node(self, path, defer_load=False, lazy_load=False, media=None):
        ...
        if is_js:
            ...
            if is_asset_bundle:
                attributes['onerror'] = "__oiAssetError=1"
