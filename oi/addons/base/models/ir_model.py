...
from oi import api, fields, models, tools, Command
from oi.exceptions import AccessError, UserError, ValidationError
from oi.osv import expression
from oi.tools import format_list, lazy_property, sql, unique, OrderedSet, SQL
from oi.tools.safe_eval import safe_eval, datetime, dateutil, time
from oi.tools.translate import _, LazyTranslate
...
class IrModel(models.Model):
    ...
    def unlink(self):
        ...
        # reload is done independently in oi.modules.loading.
...
class IrModelConstraint(models.Model):
    """
    This model tracks PostgreSQL foreign keys and constraints used by Oi
    models.
    """
...
class IrModelRelation(models.Model):
    """
    This model tracks PostgreSQL tables used to implement Oi many2many
    relations.
    """
...
class IrModelData(models.Model):
    """Holds external identifier keys for records in the database.
       This has two main uses:
           ...
           * allows tracking the origin of data installed by Oi
