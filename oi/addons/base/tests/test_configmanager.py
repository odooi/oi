...
import oi
from oi.tests import TransactionCase
from oi.tools import file_path, file_open, file_open_temporary_directory
from oi.tools.config import conf, configmanager, _get_default_datadir


IS_POSIX = 'workers' in oi.tools.config.options
ROOT_PATH = oi.tools.config.options['root_path'].removesuffix('/oi')
...
class TestConfigManager(TransactionCase):
    ...
    def setUp(self):
        ...
        self.patch(conf, 'addons_paths', oi.conf.addons_paths)
        self.patch(conf, 'server_wide_modules', oi.conf.server_wide_modules)
    ...
    def test_01_default_config(self):
        ...
        default_values = {
            ...
            'import_partial': '',
            'pidfile': '',
            'addons_path': f'{ROOT_PATH}/oi/addons,{ROOT_PATH}/addons',
            'upgrade_path': '',
            'pre_upgrade_scripts': '',
    ...
    def test_02_config_file(self):
        values = {
            ...
            'reportgz': True,
            'root_path': f'{ROOT_PATH}/oi',  # blacklist for save, ignored from the config file
    ...
    def test_04_oi16_config_file(self):
        # test that loading the Oi 16.0 generated default config works
