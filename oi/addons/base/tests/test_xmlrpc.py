...
from oi.exceptions import AccessDenied, AccessError
from oi.http import _request_stack

import oi
import oi.tools
from oi.tests import common
from oi.service import common as auth, model
from oi.tools import DotDict
...
class TestXMLRPC(common.HttpCase):
    ...
    def test_xmlrpc_defaultdict_marshalling(self):
        ...
        self.patch(self.registry['res.users'], 'context_get',
                   oi.api.model(lambda *_: collections.defaultdict(int)))
