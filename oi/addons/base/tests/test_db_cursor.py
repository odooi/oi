...
from oi.sql_db import db_connect, TestCursor
from oi.tests import common
from oi.tests.common import BaseCase, HttpCase
from oi.tools.misc import config
...
class TestTestCursor(common.TransactionCase):
    def setUp(self):
        ...
        self.env = oi.api.Environment(self.cr, oi.SUPERUSER_ID, {})
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('oi.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:oi.sql_db:Found different un-closed cursor', msg)
