...
from oi.tests.common import TransactionCase, BaseCase
from oi.tools import mute_logger
from oi.tools.safe_eval import safe_eval, const_eval, expr_eval
...
class TestSafeEval(BaseCase):
    ...
    @mute_logger('oi.tools.safe_eval')
