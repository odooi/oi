...
from oi.addons.base.models.res_users import is_selection_groups, get_selection_groups, name_selection_groups
from oi.exceptions import UserError, ValidationError
from oi.http import _request_stack
from oi.tests import Form, TransactionCase, new_test_user, tagged, HttpCase, users
...
class TestUsers(TransactionCase):
    ...
    @mute_logger('oi.sql_db', 'oi.addons.base.models.res_users_deletion')
    ...
    def test_context_get_lang(self):
        ...
        request_patch = patch('oi.addons.base.models.res_users.request', request)
