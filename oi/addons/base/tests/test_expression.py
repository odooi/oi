...
from oi.addons.base.tests.common import SavepointCaseWithUserDemo
from oi.tests.common import BaseCase, TransactionCase
...
class TestExpression(SavepointCaseWithUserDemo, TransactionExpressionCase):
    ...
    def test_10_hierarchy_in_m2m(self):
        ...
        with self.assertLogs('oi.osv.expression'):
    ...
    def test_15_m2o(self):
        ...
        # that don't have Oi has a parent company, you expect to find,
    ...
    def test_like_cast(self):
        ...
        with mute_logger('oi.sql_db'), self.assertRaises(psycopg2.Error):
    ...
    def test_active(self):
        ...
        vals = {
            ...
            'child_ids': [Command.create({'name': 'address of Oi Test', 'country_id': self.ref("base.be")})],
        }
        Partner.create(vals)
