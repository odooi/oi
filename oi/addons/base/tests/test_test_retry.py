...
from oi.tests import BaseCase, TransactionCase, tagged, BaseCase
from oi.tests.common import _logger as test_logger
...
class TestRetry(TestRetryCommon):
    """ Check some tests behaviour when OI_TEST_FAILURE_RETRIES is set"""
