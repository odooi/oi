...
from oi.tests.common import new_test_user, Like
from oi.tools import mute_logger
from oi.addons.test_http.utils import HtmlTokenizer
...
class TestHttpModels(TestHttpBase):
    ...
    def test_models5_stargate_setname_readonly(self):
        ...
        with self.assertLogs('oi.http', 'WARNING') as capture_http,\
             self.assertLogs('oi.sql_db', 'WARNING') as capture_sql_db:
