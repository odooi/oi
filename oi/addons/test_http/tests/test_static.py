...
import oi
from oi.tests import new_test_user, tagged, RecordCapturer
from oi.tools import config, file_open, image_process
from oi.tools.misc import submap
...
class TestHttpStaticLogo(TestHttpStaticCommon):
    ...
    def setUpClass(cls):
        ...
        super_user = cls.env['res.users'].browse([oi.SUPERUSER_ID])
