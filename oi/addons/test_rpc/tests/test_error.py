...
class TestError(common.HttpCase):
    ...
    def test_01_private(self):
        with self.assertRaisesRegex(Exception, r"Private method"), mute_logger('oi.http'):
    ...
    def test_01_create(self):
        ...
        try:
            with mute_logger("oi.sql_db", "oi.http"):
    ...
    def test_03_sql_constraint(self):
        with mute_logger("oi.sql_db"), mute_logger("oi.http"):
