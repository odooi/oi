...
from oi.tests import Form, TransactionCase, users
from oi.tools import mute_logger, get_lang
...
class PropertiesCase(TestPropertiesMixin):
    ...
    @mute_logger('oi.models.unlink', 'oi.fields')
    ...
    @users('test')
    @mute_logger('oi.addons.base.models.ir_rule', 'oi.fields')
    ...
    def test_properties_field_security(self):
        ...
        self.env.invalidate_all()
        with patch('oi.addons.test_new_api.models.test_new_api.MultiTag.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        ...
        self.env.invalidate_all()
        with patch('oi.addons.test_new_api.models.test_new_api.Discussion.check_access', _mocked_check_access):
            values = message.read(['attributes'])[0]['attributes'][0]
        self.assertEqual(values['value'], (tag.id, 'Test Tag'))
...
class PropertiesGroupByCase(TestPropertiesMixin):
    ...
    @mute_logger('oi.fields', 'oi.models.unlink')
