...
class TestUi(HttpCaseWithUserDemo):
    ...
    def test_01_admin_widget_x2many(self):
        ...
        self.start_tour("/oi/action-test_new_api.action_discussions",
            'widget_x2many', login="admin", timeout=120)


@oi.tests.tagged('-at_install', 'post_install')
class TestUiTranslation(oi.tests.HttpCase):

    @mute_logger('oi.sql_db', 'oi.http')
    def test_01_sql_constraints(self):
        ...
        self.start_tour("/oi/action-test_new_api.action_categories",
