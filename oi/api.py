...
"""The Oi API module defines Oi Environments and method decorators.
...
from oi.tools.misc import StackMap
...
def constrains(*args: str) -> Callable[[T], T]:
    ...
    Should raise :exc:`~oi.exceptions.ValidationError` if the
    validation failed.
...
def ondelete(*, at_uninstall):
    """
    Mark a method to be executed during :meth:`~oi.models.BaseModel.unlink`.
...
def onchange(*args):
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/oi/oi/issues/2693>`_.
...
class Environment(Mapping):
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        ...
        :type cursor: :class:`~oi.sql_db.Cursor`
    ...
    def user(self):
        ...
        :rtype: :class:`res.users record<~oi.addons.base.models.res_users.Users>`"""
    ...
    def company(self):
        ...
        :rtype: :class:`res.company record<~oi.addons.base.models.res_company.Company>`
    ...
    def companies(self):
        ...
        :rtype: :class:`res.company recordset<~oi.addons.base.models.res_company.Company>`
...
class Transaction:
    ...
    def __init__(self, registry):
        ...
        # temporary directories (managed in oi.tools.file_open_temporary_directory)
