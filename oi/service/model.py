...
from oi.tools import DotDict, lazy
from oi.tools.translate import translate_sql_constraint
...
def execute_cr(cr, uid, obj, method, *args, **kw):
    ...
    result = retrying(partial(oi.api.call_kw, recs, method, args, kw), env)
...
def retrying(func, env):
    ...
    :param oi.api.Environment env: The environment where the registry
