...
This tool provides utilities to duplicate records across models in Oi, while maintaining referential integrity,
...
from oi.tools.sql import SQL
from oi.fields import Field, Many2one
