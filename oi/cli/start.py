...
from oi.modules.module import get_module_root, MANIFEST_NAMES
from oi.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """ Quickly start the oi server with default options """
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            oi.tools.config['init']['base'] = True
