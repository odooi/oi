...
For now, configuration code is in oi.tools.config. It is in mainly
...
To initialize properly this module, oi.tools.config.parse_config()
must be used.

"""

# Paths to search for Oi addons.
addons_paths = []
...
# installed (i.e. the majority of Oi addons). This is set with the --load
# command-line option.
server_wide_modules = []
