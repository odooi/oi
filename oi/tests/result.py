...
OI_TEST_MAX_FAILED_TESTS = max(1, int(os.environ.get('OI_TEST_MAX_FAILED_TESTS', sys.maxsize)))

stats_logger = logging.getLogger('oi.tests.stats')
...
class OiTestResult(object):
    ...
    def _checkShouldStop(self):
        if self.total_errors_count() >= OI_TEST_MAX_FAILED_TESTS:
            ...
            if not global_report.shouldStop:
                _logger.error(
                    ...
                    "Remaining tests will be skipped.", OI_TEST_MAX_FAILED_TESTS)
