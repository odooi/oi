...
product_name = 'Oi'
description = 'Oi Server'
long_desc = '''Oi is a complete ERP and CRM. The main features are accounting (analytic
...
author = 'Oi S.A.'
author_email = 'info@odoodooi.com'
license = 'LGPL-3'

nt_service_name = "oi-server-" + series.replace('~','-')
