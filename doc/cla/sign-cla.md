...
In order for your contribution to Oi to be accepted, you have to sign the
Oi Contributor License Agreement (CLA). More information about this
...
2.  Modify your current pull request, or make a new pull request on
    [oi/oi](https://github.com/oi/oi), adding a new file
...
I hereby agree to the terms of the Oi Individual Contributor License
Agreement v1.0.
...
3. An Oi R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    [oi/oi](/oi/oi), adding a new file `<lowercase-company-name>.md`
    under the [`doc/cla/corporate`](corporate/) directory.
    If the name of the company is Oi, the file would be
    `doc/cla/corporate/oi.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the Oi Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `odoodooi.com`.  In that case someone from the Oi team will
make the pull request on your behalf.

* Printable Oi CCLA v1.0 https://www.odoodooi.com/files/legal/Oi-CCLA-v1.0.pdf
* Printable Oi ICLA v1.0 https://www.odoodooi.com/files/legal/Oi-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for Oi is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the Oi project

* protect the Oi project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the Oi project and its users from bad actors who would contribute
...
contributor really intended to contribute to the Oi project under specific
...
The Oi CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, Oi S.A. to use, modify and
...
(ICLA) of Oi.  The agreement is executed by adding your name and
