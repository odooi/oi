...
[Contact Info](https://www.odoodooi.com/security-report)
...
Our [Responsible Disclosure](https://www.odoodooi.com/security-report) page gives an overview of the
process, including:
...
We receive a majority of security reports that have little to no impact on the security of Oi or
the Oi Cloud, and we ultimately have to reject them. To avoid a disappointing experience when
...
Also be sure to review our list of [non-qualifying issues](https://www.odoodooi.com/security-report#what).
