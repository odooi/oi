...
patch(Wysiwyg.prototype, {
    ...
    _loadIframe() {
        var self = this;
        this.$editable = $('<div class="note-editable oe_structure oi-editor-editable"></div>');
        this.$el.removeClass('note-editable oe_structure oi-editor-editable');
        ...
        var def = new Promise(function (resolve) {
            window.top[self._onUpdateIframeId] = function (_avoidDoubleLoad) {
                ...
                const $iframeWrapper = $('<div class="iframe-editor-wrapper oi-editor">');
...
function getWysiwygIframeContent(params) {
    ...
    return `
        ...
        <script type="text/javascript">
            window.oi?.define('root.widget', ['@web/legacy/js/public/public_widget'], function (require) {
                'use strict';
    ...
    <body class="o_in_iframe">
        ...
        <script type="text/javascript">
            window.oi?.define('web_editor.wysiwyg.iniframe', [], function (require) {
                'use strict';
