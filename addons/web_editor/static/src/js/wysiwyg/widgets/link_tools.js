...
import { isButton } from "@web_editor/js/editor/oi-editor/src/OiEditor";
...
export class LinkTools extends Link {
    ...
    applyLinkToDom() {
        ...
        this.props.wysiwyg.oiEditor.historyStep();
    ...
    _onColorpaletteColorPicked(cssProperty, params) {
        ...
        this.props.wysiwyg.oiEditor.execCommand('applyColor', '', 'color');
        this.props.wysiwyg.oiEditor.execCommand('applyColor', '', 'backgroundColor');
    ...
    __onURLInput() {
        ...
        this.props.wysiwyg.oiEditor.historyPauseSteps('_onURLInput');
        this._checkDocumentState();
        this._syncContent();
        this._adaptPreview();
        this.props.wysiwyg.oiEditor.historyUnpauseSteps('_onURLInput');
    }
    /**
