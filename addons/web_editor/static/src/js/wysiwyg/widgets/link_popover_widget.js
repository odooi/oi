...
export class LinkPopoverWidget {
    static createFor(params) {
        ...
        params.wysiwyg?.oiEditor.observerUnactive('LinkPopoverWidget');
        popoverWidget.start(); // This is not async
        params.wysiwyg?.oiEditor.observerActive('LinkPopoverWidget');
    ...
    start() {
        ...
        const editable = this.wysiwyg.oiEditor.editable;
        this.$target.popover({
            html: true,
            content: this.$el,
            placement: 'bottom',
        ...
        if (document !== this.wysiwyg.oiEditor.document) {
            $(this.wysiwyg.oiEditor.document).on('mouseup.link_popover', onClickDocument);
        }
    ...
    destroy() {
        ...
        $(this.wysiwyg.oiEditor.document).off('.link_popover');
