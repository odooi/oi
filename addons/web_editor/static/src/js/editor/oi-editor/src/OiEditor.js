...
export class OiEditor extends EventTarget {
    constructor(editable, options = {}) {
        ...
        this.options = defaultOptions(
            {
                ...
                // `convertNumericToUnit` as oi-editor utils to avoid this
        ...
        this.editable.classList.add("oi-editor-editable");
    ...
    _onClipboardCopy(clipboardEvent) {
        ...
        const oiHtml = dataHtmlElement.innerHTML.replace(/\uFEFF/g, "");
        const oiText = selection.toString().replace(/\uFEFF/g, "").replace(/\u00A0/g, " ");
        clipboardEvent.clipboardData.setData('text/plain', oiText);
        clipboardEvent.clipboardData.setData('text/html', oiHtml);
        clipboardEvent.clipboardData.setData('text/oi-editor', oiHtml);
    }
    /**
     * @private
     */
    ...
    isSelectionInBlockRoot() {
        ...
        while (
            ...
            !currentNode.classList.contains('oi-editor-editable') &&
    ...
    _onPaste(ev) {
        ...
        const oiEditorHtml = ev.clipboardData.getData('text/oi-editor');
        ...
        } else if (oiEditorHtml) {
            const fragment = parseHTML(this.document, oiEditorHtml);
