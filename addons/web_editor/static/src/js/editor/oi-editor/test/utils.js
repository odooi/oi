...
import { OiEditor } from '../src/OiEditor.js';
...
export async function testEditor(Editor = OiEditor, spec, options = {}) {
    hasMobileTest = false;
...
export const pasteOiEditorHtml = async (editor, html) => pasteData(editor, html, 'text/oi-editor');
...
export class BasicEditor extends OiEditor {}
