...
import { OiEditor, parseHTML, setSelection, insertCharsAt } from '../../src/OiEditor.js';
import {
...
const testMultiEditor = async spec => {
    ...
    for (const clientInfo of clientInfosList) {
        ...
        let nextId = 1;
        OiEditor.prototype._generateId = () => 'fake_id_' + nextId++;

        clientInfo.editor = new OiEditor(clientInfo.editable, Object.assign({
            toSanitize: false,
    ...
    OiEditor.prototype._generateId = () => 'fake_concurent_id_' + concurentNextId++;
