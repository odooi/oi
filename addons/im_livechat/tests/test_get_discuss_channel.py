...
from oi.addons.im_livechat.tests.common import TestImLivechatCommon
from oi.addons.mail.tests.common import MailCommon
from oi.tests import new_test_user, tagged
...
class TestGetDiscussChannel(TestImLivechatCommon, MailCommon):
    ...
    def test_channel_get_livechat_visitor_info(self):
        ...
        with patch('oi.http.GeoIP.country_code', new_callable=PropertyMock(return_value=belgium.code)):
