...
from oi import http, tools, _, release
from oi.exceptions import UserError
from oi.http import request
from oi.tools import replace_exceptions
...
class LivechatController(http.Controller):
    ...
    @http.route('/im_livechat/oi_ui_icons', type='http', auth='none', cors="*")
    def oi_ui_icons(self, **kwargs):
        return http.Stream.from_path('web/static/lib/oi_ui_icons/fonts/oi_ui_icons.woff2').get_response()
