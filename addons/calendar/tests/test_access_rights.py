...
from oi.tests.common import TransactionCase, new_test_user
...
class TestAccessRights(TransactionCase):
    ...
    @classmethod
    @mute_logger('oi.tests', 'oi.addons.auth_signup.models.res_users')
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_meeting_edit_access_notification_handle_in_oi(self):
        # set notifications to "handle in Oi" in Preferences for john, raoul, and george
        ...
        # this verifies that users with "handle in Oi" notification setting can
