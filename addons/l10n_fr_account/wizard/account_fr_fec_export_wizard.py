...
import csv
import io
from oi.tools import float_is_zero, SQL
from oi import fields, models, api
...
class FecExportWizard(models.TransientModel):
    ...
    def generate_fec(self):
        ...
        # 1) the XSD file impose to have the label on the account.move, but Oi has the label on the account.move.line,
        # so that's a  problem !
