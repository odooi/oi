# Part of Oi. See LICENSE file for full copyright and licensing details.
{
    ...
    'website': 'https://www.odoodooi.com/documentation/master/applications/finance/fiscal_localizations/france.html',
    'icon': '/account/static/description/l10n.png',
    'version': '2.2',
    'countries': ['fr'],
    'category': 'Accounting/Localizations/Account Charts',
    'description': """
This is the module to manage the accounting chart for France in Oi.
========================================================================
