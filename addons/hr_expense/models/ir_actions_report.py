...
from oi.tools.pdf import OiPdfFileReader, OiPdfFileWriter
    ...
    def _render_qweb_pdf_prepare_streams(self, report_ref, data, res_ids=None):
        ...
        if report.report_name == 'hr_expense.report_expense_sheet':
            ...
            for expense_sheet in expense_sheets:
                ...
                expense_report = OiPdfFileReader(stream, strict=False)
                output_pdf = OiPdfFileWriter()
                ...
                for attachment in attachments:
                    ...
                    attachment_reader = OiPdfFileReader(attachment_stream, strict=False)
