...
from oi import api, fields, Command, models, _
from oi.exceptions import UserError, ValidationError
from oi.tools import email_split, float_repr, float_round, is_html_empty
...
class HrExpense(models.Model):
    ...
    def _compute_currency_rate(self):
        """
            We want the default oi rate when the following change:
