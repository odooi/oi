...
from oi.tests.common import TransactionCase, users
...
from oi.tools import mute_logger, convert_file
...
class TestSmsTemplateAccessRights(TransactionCase):
    ...
    @users('user_system')
    @mute_logger('oi.models.unlink', 'oi.addons.base.models.ir_model')
...
class TestSMSTemplateReset(TransactionCase):
    ...
    def test_sms_template_reset(self):
        ...
        self.assertEqual(sms_template.body.strip(), Markup('<div>Hello Oi</div>'))
