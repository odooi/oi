...
from oi.addons.payment import utils as payment_utils
from oi.addons.payment.tests.http_common import PaymentHttpCommon
from oi.addons.payment_adyen import utils as adyen_utils
from oi.addons.payment_adyen.controllers.main import AdyenController
from oi.addons.payment_adyen.tests.common import AdyenCommon
...
class AdyenTest(AdyenCommon, PaymentHttpCommon):
    ...
    def test_processing_values(self):
        ...
        with mute_logger('oi.addons.payment.models.payment_transaction'), \
            patch(
                'oi.addons.payment.utils.generate_access_token',
        ...
        with patch(
            'oi.addons.payment.utils.generate_access_token', new=self._generate_test_access_token
        ):
    ...
    @mute_logger('oi.addons.payment_adyen.models.payment_transaction')
    def test_send_refund_request(self):
        ...
        with patch(
            'oi.addons.payment_adyen.models.payment_provider.PaymentProvider._adyen_make_request',
    ...
    @mute_logger('oi.addons.payment_adyen.controllers.main')
    @mute_logger('oi.addons.payment_adyen.models.payment_transaction')
    def _webhook_notification_flow(self, payload):
        ...
        with patch(
            'oi.addons.payment_adyen.controllers.main.AdyenController'
    ...
    def test_webhook_notification_triggers_signature_check(self):
        ...
        with patch(
            ...
            'oi.addons.payment.models.payment_transaction.PaymentTransaction'
