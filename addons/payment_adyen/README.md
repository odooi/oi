...
- `17.0`
  - The Web Drop-in SDK is replaced by the Web Components SDK (version 5.39.0); the Checkout and
    Recurring APIs are updated to versions 70 and 68. oi/oi#120446
...
- `16.2`
  - The support for partial manual capture is added. oi/oi#87251
- `16.0`
  - Archiving a token no longer deactivates the related payment method on Adyen. oi/oi#93774
- `15.3`
  - The support for manual capture is added. oi/oi#70591
- `15.2`
...
- `15.0`
  - The support for both full and partial refunds is added. oi/oi#70881
  - The Web Drop-in SDK is migrated to version 4.7.3 and the Checkout API to version 67 to switch
    from relying on origin keys and use client keys instead. oi/oi#74827
- `14.3`
