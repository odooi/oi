...
from oi.addons.payment_razorpay.controllers.main import RazorpayController
from oi.addons.payment_razorpay.tests.common import RazorpayCommon


@tagged('post_install', '-at_install')
class TestProcessingFlows(RazorpayCommon, PaymentHttpCommon):

    @mute_logger('oi.addons.payment_razorpay.controllers.main')
    def test_webhook_notification_triggers_processing(self):
        ...
        with patch(
            'oi.addons.payment_razorpay.controllers.main.RazorpayController.'
    ...
    def test_accept_webhook_notification_with_valid_signature(self):
        ...
        with patch(
            'oi.addons.payment_razorpay.models.payment_provider.PaymentProvider'
