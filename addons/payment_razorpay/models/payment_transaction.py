...
from oi.addons.payment_razorpay import const
...
class PaymentTransaction(models.Model):
    ...
    def _send_void_request(self, amount_to_void=None):
        ...
        raise UserError(_("Transactions processed by Razorpay can't be manually voided from Oi."))
    ...
    def _get_tx_from_notification_data(self, provider_code, notification_data):
        ...
        if entity_type == 'payment':
            ...
            if reference:  # The refund was initiated from Oi.
                tx = self.search([('reference', '=', reference), ('provider_code', '=', 'razorpay')])
