...
from oi.addons.test_mail_sms.tests.test_sms_management import TestSMSActionsCommon
from oi.tests.common import HttpCase, JsonRpcException
...
class TestSmsController(HttpCase, TestSMSActionsCommon):
    ...
    @mute_logger("oi.addons.base.models.ir_http")
    ...
    @mute_logger('oi.addons.base.models.ir_http', 'oi.addons.sms.controllers.main', 'oi.http')
