...
featurePluginRegistry.add("oiAccountingAggregates", AccountingPlugin);
...
cellMenuRegistry.add("move_lines_see_records", {
    ...
    async execute(env) {
        ...
        if ( func.functionName === "OI.PARTNER.BALANCE" ) {
        ...
        if ( date_range?.value && !isEvaluationError(date_range.value) ) {
            ...
            if ( ["OI.PARTNER.BALANCE", "OI.RESIDUAL"].includes(func.functionName) ) {
