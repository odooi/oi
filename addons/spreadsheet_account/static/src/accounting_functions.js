...
import { EvaluationError } from "@oi/o-spreadsheet";
...
const OI_PARTNER_BALANCE_ARGS = () => {
    const partner_arg = arg("partner_ids (string)", _t("The partner ids (separated by a comma)."));
    return [partner_arg, ...OI_RESIDUAL_ARGS()];
}

functionRegistry.add("OI.CREDIT", {
...
functionRegistry.add("OI.BALANCE", {
...
functionRegistry.add("OI.FISCALYEAR.START", {
...
functionRegistry.add("OI.FISCALYEAR.END", {
...
functionRegistry.add("OI.ACCOUNT.GROUP", {
