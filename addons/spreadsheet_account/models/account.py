...
class AccountMove(models.Model):
    ...
    def spreadsheet_fetch_debit_credit(self, args_list):
        """Fetch data for OI.CREDIT, OI.DEBIT and OI.BALANCE formulas
    ...
    def spreadsheet_fetch_residual_amount(self, args_list):
        """Fetch data for OI.RESUDUAL formulas
        The input list looks like this:
        [{
            date_range: {
                range_type: "year"
    ...
    def spreadsheet_fetch_partner_balance(self, args_list):
        """Fetch data for OI.PARTNER.BALANCE formulas
        The input list looks like this:
        [{
            date_range: {
                range_type: "year"
