...
from oi.addons.pos_self_order.tests.self_order_common_test import SelfOrderCommonTest
from oi.addons.pos_restaurant.tests.test_frontend import TestFrontendCommon
