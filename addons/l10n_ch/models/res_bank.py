...
from oi.addons.base_iban.models.res_partner_bank import normalize_iban, pretty_iban, validate_iban
from oi.exceptions import ValidationError
from oi.tools import LazyTranslate
from oi.tools.misc import mod10r
