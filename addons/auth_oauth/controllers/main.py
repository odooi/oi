...
from oi import api, http, SUPERUSER_ID, _
from oi.exceptions import AccessDenied
from oi.http import request, Response
from oi import registry as registry_get
from oi.tools.misc import clean_context

from oi.addons.auth_signup.controllers.main import AuthSignupHome as Home
from oi.addons.web.controllers.utils import ensure_db, _get_login_redirect_url
...
class OAuthController(http.Controller):
    ...
    def signin(self, **kw):
        ...
        try:
            ...
            if redirect:
                ...
                url = '/oi/action-%s' % action
            elif menu:
                url = '/oi?menu_id=%s' % menu
    ...
    def oea(self, **kw):
        """login user via Oi Account provider"""
        ...
        with registry.cursor() as cr:
            try:
                ...
                provider = env.ref('auth_oauth.provider_oi')
            except ValueError:
