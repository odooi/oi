...
from oi import api, fields, models, _, tools
from oi.exceptions import ValidationError, MissingError

from oi.addons.spreadsheet.utils.validate_data import fields_in_spreadsheet, menus_xml_ids_in_spreadsheet
...
class SpreadsheetMixin(models.AbstractModel):
    ...
    def _empty_spreadsheet_data(self):
        ...
        locale = lang._oi_lang_to_spreadsheet_locale()
        return {
            "version": 1,
            "sheets": [
                {
