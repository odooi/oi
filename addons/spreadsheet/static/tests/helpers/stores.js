...
import { stores } from "@oi/o-spreadsheet";
...
/**
 * @template T
 * @typedef {import("@oi/o-spreadsheet").StoreConstructor<T>} StoreConstructor<T>
 */
 ...
 * @param  {any[]} args
 * @return {Promise<{ store: T, container: InstanceType<DependencyContainer>, model: OiSpreadsheetModel }>}
 */
...
/**
 * @template T
 * @param {import("@oi/o-spreadsheet").Model} model
 * @param {StoreConstructor<T>} Store
 * @param  {any[]} args
 * @return {{ store: T, container: InstanceType<DependencyContainer>, model: OiSpreadsheetModel }}
 */
