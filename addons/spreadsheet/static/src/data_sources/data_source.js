...
import { CellErrorType, EvaluationError } from "@oi/o-spreadsheet";
import { _t } from "@web/core/l10n/translation";

/**
 * @typedef {import("./oi_data_provider").OiDataProvider} OiDataProvider
...
export class LoadableDataSource {
    /**
     * @param {Object} param0
     * @param {OiDataProvider} param0.oiDataProvider
     */
    constructor({ oiDataProvider }) {
        /** @protected */
    ...
    get _orm() {
        return this.oiDataProvider.orm;
    }

    get serverData() {
        return this.oiDataProvider.serverData;
    }
    ...
    async load(params) {
        if (params && params.reload) {
            this.oiDataProvider.cancelPromise(this._loadPromise);
            this._loadPromise = undefined;
        }
        if (!this._loadPromise) {
            ...
            await this.oiDataProvider.notifyWhenPromiseResolves(this._loadPromise);
        }
 ...
 * @param {string} model
 * @returns {Promise<import("@spreadsheet").OiFields>}
 */
