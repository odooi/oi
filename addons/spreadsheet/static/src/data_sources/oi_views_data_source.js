...
/**
 * @typedef {Object} OiModelMetaData
 * @property {string} resModel
 * @property {OiFields} [fields]
 *
 * @typedef {Object} OiModelSearchParams
 * @property {Object} context
 * @property {Array<string>} domain
 */

export class OiViewsDataSource extends LoadableDataSource {
    /**
     * @override
     * @param {Object} services
     * @param {Object} params
     * @param {OiModelMetaData} params.metaData
     * @param {Object} params.searchParams
     */
    constructor(services, params) {
        super(services);
        /** @type {OiModelMetaData} */
    ...
    /**
     * @returns {OiFields} List of fields
     */
    getFields() {
     ...
     * @returns {OiField | undefined} Field
     */
    getField(field) {
        this._assertMetaDataLoaded();
