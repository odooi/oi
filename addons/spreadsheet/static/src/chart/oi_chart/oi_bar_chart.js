...
export class OiBarChart extends OiChart {
...
chartRegistry.add("oi_bar", {
    match: (type) => type === "oi_bar",
    createChart: (definition, sheetId, getters) => new OiBarChart(definition, sheetId, getters),
    getChartRuntime: createOiChartRuntime,
    validateChartDefinition: (validator, definition) =>
        OiBarChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => OiBarChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () => OiBarChart.getDefinitionFromContextCreation(),
    name: _t("Bar"),
});
