...
chartRegistry.add("oi_pie", {
    match: (type) => type === "oi_pie",
    createChart: (definition, sheetId, getters) => new OiChart(definition, sheetId, getters),
    getChartRuntime: createOiChartRuntime,
    validateChartDefinition: (validator, definition) =>
        OiChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => OiChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () => OiChart.getDefinitionFromContextCreation(),
    name: _t("Pie"),
});
