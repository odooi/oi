...
import { AbstractChart, CommandResult } from "@oi/o-spreadsheet";
 ...
 *
 * @typedef OiChartDefinitionDataSource
 * @property {MetaData} metaData
 * @property {SearchParams} searchParams
 *
 */

export class OiChart extends AbstractChart {
    /**
     * @param {OiChartDefinition} definition
    ...
    static getDefinitionFromContextCreation() {
        throw new Error("It's not possible to convert an Oi chart to a native chart");
    }

    /**
     * @returns {OiChartDefinitionDataSource}
     */
