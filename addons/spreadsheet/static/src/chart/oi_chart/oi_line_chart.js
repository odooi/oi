...
export class OiLineChart extends OiChart {
...
chartRegistry.add("oi_line", {
    match: (type) => type === "oi_line",
    createChart: (definition, sheetId, getters) => new OiLineChart(definition, sheetId, getters),
    getChartRuntime: createOiChartRuntime,
    validateChartDefinition: (validator, definition) =>
        OiLineChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => OiLineChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () => OiLineChart.getDefinitionFromContextCreation(),
    name: _t("Line"),
});

function createOiChartRuntime(chart, getters) {
    ...
    for (const index in datasets) {
        ...
        if (chart.fillArea) {
            ...
            // use the transparency of Oi to keep consistency
...
function getLineConfiguration(chart, labels, locale) {
    ...
    config.type = chart.type.replace("oi_", "");
    const legend = {
