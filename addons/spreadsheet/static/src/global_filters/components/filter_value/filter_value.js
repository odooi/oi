...
import { Component, onWillStart } from "@oi/owl";
import { components } from "@oi/o-spreadsheet";
...
export class FilterValue extends Component {
    ...
    setup() {
        ...
        onWillStart(async () => {
            ...
            try {
                const oiDataProvider = this.props.model.config.custom.oiDataProvider;
                await getFields(oiDataProvider.serverData, this.filter.modelName);
                this.isValid = true;
            } catch (e) {
