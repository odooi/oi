...
export class GlobalFiltersUIPlugin extends OiUIPlugin {
    ...
    constructor(config) {
        ...
        this.oiDataProvider = config.custom.oiDataProvider;
        /**
        ...
        switch (filter.type) {
            ...
            case "relation":
                ...
                if (!this.recordsDisplayName[filter.id]) {
                    ...
                    this.oiDataProvider.notifyWhenPromiseResolves(promise);
                    return [[{ value: "" }]];
                }
