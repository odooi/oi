...
import { helpers, constants, EvaluationError, SpreadsheetPivotTable } from "@oi/o-spreadsheet";
...
/**
 * @typedef {import("@oi/o-spreadsheet").PivotTableColumn} PivotTableColumn
 * @typedef {import("@oi/o-spreadsheet").PivotTableRow} PivotTableRow
 ...
 */
export class OiPivotModel extends PivotModel {
    /**
     * @param {import("@web/env").OiEnv} env
     * @param {import("@spreadsheet").OiPivotModelParams} params
    ...
    constructor(env, params, services) {
        ...
        /**
         * @type {import("@spreadsheet").OiGetters}
         */
    ...
    /**
     * Get the Oi domain corresponding to the given domain
     * @param {PivotDomain} domain
     */
    ...
    /**
     * @param {import("@oi/o-spreadsheet").PivotDimension} dimension
