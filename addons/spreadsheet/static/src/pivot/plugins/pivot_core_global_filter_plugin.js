...
/**
 *
 * @typedef {import("@spreadsheet").OiPivotDefinition} OiPivotDefinition
...
export class PivotCoreGlobalFilterPlugin extends OiCorePlugin {
        ...
        globalFiltersFieldMatchers["pivot"] = {
            getIds: () =>
                this.getters
                    ...
                    .filter(
                        (id) =>
                            this.getters.getPivotCoreDefinition(id).type === "OI" &&
                            id in this.pivots
                    ),
            ...
            getModel: (pivotId) => {
                ...
                return pivot.type === "OI" && pivot.model;
            },
        };
    }
    ...
    export(data) {
        for (const id in this.pivots) {
            ...
            data.pivots[id].fieldMatching =
                pivot.type === "OI" ? this.pivots[id].fieldMatching : {};
        }
    }
}
