...
import { registries, helpers, constants } from "@oi/o-spreadsheet";
...
function boundedOiNumberDateAdapter(lower, upper) {
    return {
        normalizeServerValue(groupBy, field, readGroupResult) {
            return Number(readGroupResult[groupBy]);
        },
...
pivotTimeAdapterRegistry.add("week", falseHandlerDecorator(oiWeekAdapter));
pivotTimeAdapterRegistry.add("month", falseHandlerDecorator(oiMonthAdapter));
pivotTimeAdapterRegistry.add("quarter", falseHandlerDecorator(oiQuarterAdapter));

extendSpreadsheetAdapter("day", oiDayAdapter);
extendSpreadsheetAdapter("year", oiNumberDateAdapter);
extendSpreadsheetAdapter("day_of_month", boundedOiNumberDateAdapter(1, 31));
extendSpreadsheetAdapter("day", oiDayAdapter);
extendSpreadsheetAdapter("iso_week_number", boundedOiNumberDateAdapter(0, 54));
extendSpreadsheetAdapter("month_number", boundedOiNumberDateAdapter(1, 12));
extendSpreadsheetAdapter("quarter_number", boundedOiNumberDateAdapter(1, 4));
extendSpreadsheetAdapter("day_of_week", oiDayOfWeekAdapter);
extendSpreadsheetAdapter("hour_number", oiHourNumberAdapter);
extendSpreadsheetAdapter("minute_number", oiMinuteNumberAdapter);
extendSpreadsheetAdapter("second_number", oiSecondNumberAdapter);
