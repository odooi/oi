...
import { PivotOiCorePlugin } from "./plugins/pivot_oi_core_plugin";
...
coreTypes.add("UPDATE_OI_PIVOT_DOMAIN");

invalidateEvaluationCommands.add("UPDATE_OI_PIVOT_DOMAIN");
...
inverseCommandRegistry.add("UPDATE_OI_PIVOT_DOMAIN", identity);

export { PivotOiCorePlugin, PivotUIGlobalFilterPlugin };
