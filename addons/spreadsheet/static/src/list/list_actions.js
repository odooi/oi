...
import { astToFormula, helpers } from "@oi/o-spreadsheet";
...
/**
 * @param {import("@oi/o-spreadsheet").CellPosition} position
...
/**
 * @param {import("@oi/o-spreadsheet").CellPosition} position
 * @param {import("@spreadsheet").OiGetters} getters
 * @returns {boolean}
 */
export const SEE_RECORD_LIST_VISIBLE = (position, getters) => {
    ...
    return !!(
        ...
        getFirstListFunction(cell.compiledFormula.tokens).functionName === "OI.LIST"
    );
};
