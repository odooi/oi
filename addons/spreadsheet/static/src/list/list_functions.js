...
import { helpers, registries, EvaluationError } from "@oi/o-spreadsheet";
...
functionRegistry.add("OI.LIST", OI_LIST);
functionRegistry.add("OI.LIST.HEADER", OI_LIST_HEADER);
