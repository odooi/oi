...
from oi.tests.common import users, tagged, HttpCase, warmup
    ...
    def _get_init_store_data_result(self):
        ...
        return {
            ...
            "Store": {
                ...
                "oibot": {"id": self.user_root.partner_id.id, "type": "partner"},
