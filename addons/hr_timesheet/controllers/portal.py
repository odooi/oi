...
from oi.tools import date_utils, groupby as groupbyelem
from oi.osv.expression import AND, FALSE_DOMAIN

from oi.addons.portal.controllers.portal import CustomerPortal, pager as portal_pager
