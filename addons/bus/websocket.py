...
import oi
from oi import api, modules
from .models.bus import dispatch
from oi.http import root, Request, Response, SessionExpiredException, get_default_session
from oi.modules.registry import Registry
from oi.service import model as service_model
from oi.service.server import CommonServer
from oi.service.security import check_session
from oi.tools import config, lazy_property
...
class Websocket:
    ...
    def __init__(self, sock, session, cookies):
        ...
        self.__selector = (
            ...
            if oi.evented and hasattr(selectors, 'PollSelector')
...
class WebsocketConnectionHandler:
    ...
    def _handle_public_configuration(cls, request):
        if not os.getenv('OI_BUS_PUBLIC_SAMESITE_WS'):
            return
