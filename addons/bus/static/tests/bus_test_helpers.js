import { after, expect, registerDebugInfo } from "@oi/hoot";
...
import { on } from "@oi/hoot-dom";
import { registry } from "@web/core/registry";
import { patch } from "@web/core/utils/patch";

/**
 * @typedef {[
 *  env: import("@web/env").OiEnv,
...
/** @type {Record<string, (env: OiEnv, id: string, payload: any) => any>} */
const busMessageHandlers = {};
/** @type {Map<OiEnv, { id: number, type: string, payload: NotificationPayload }[]>} */
 ...
 *
 * @param {string} type
 * @param {(env: OiEnv, id: string, payload: any) => any} handler
 */
