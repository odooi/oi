/** @oi-module alias=@bus/../tests/helpers/model_definitions_setup default=false */
...
insertRecords("res.users", [
    {
        ...
        display_name: "OiBot",
        login: "__system__",
        id: TEST_USER_IDS.oibotUserId,
        name: "Public user",
        partner_id: TEST_USER_IDS.oibotId,
    },
    {
