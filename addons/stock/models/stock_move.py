...
from oi import _, api, Command, fields, models
from oi.exceptions import UserError, ValidationError
from oi.osv import expression
from oi.tools.float_utils import float_compare, float_is_zero, float_round
from oi.tools.misc import clean_context, OrderedSet, groupby
...
Please change the quantity done or the rounding precision of your unit of measure.""",
    ...
    def _propagate_date_log_note(self, move_orig):
        ...
        for doc in documents:
            ...
            doc.message_post(body=msg, author_id=oibot_id, subject=msg_subject)
