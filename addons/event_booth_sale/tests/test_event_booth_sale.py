...
from oi.addons.event_booth_sale.tests.common import TestEventBoothSaleCommon
...
from oi.tools import float_compare
...
class TestEventBoothSaleInvoice(AccountTestInvoicingCommon, TestEventBoothSaleWData):
    ...
    def test_event_booth_with_invoice(self):
        ...
        self.assertEqual(booth.state, 'unavailable')
        # When running without plus the payments get reconciled immediately.
