...
from oi.addons.base.tests.test_ir_cron import CronMixinCase
from oi.addons.mail.tests.common import mail_new_test_user, MailCommon
from oi.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE_PLAINTEXT
from oi.addons.test_mail.models.test_mail_models import MailTestSimple
from oi.addons.test_mail.tests.common import TestRecipients
from oi.api import call_kw
from oi.exceptions import AccessError
from oi.tests import tagged
from oi.tools import mute_logger, formataddr
from oi.tests.common import users
...
class TestMessageNotify(TestMessagePostCommon):
    ...
    @users('employee')
    @mute_logger('oi.addons.mail.models.mail_mail', 'oi.models.unlink', 'oi.tests')
...
class TestMessagePost(TestMessagePostCommon, CronMixinCase):
    ...
    @mute_logger('oi.addons.mail.models.mail_mail', 'oi.models.unlink')
    @users('employee')
    ...
    def test_message_post_inactive_follower(self):
        """ Test posting with inactive followers does not notify them (e.g. oibot) """
        test_record = self.env['mail.test.simple'].browse(self.test_record.ids)
                ...
                with self.assertSinglePostNotifications(
                        ...
                        message_info={
                            ...
                            'mail_mail_values': {
                                'headers': {
                                    'Return-Path': f'{expected_alias_domain.bounce_alias}@{expected_alias_domain.name}',
                                    'X-Oi-Objects': f'{record._name}-{record.id}',
                                },
                            },
                            'message_values': {
    ...
    @mute_logger('oi.addons.mail.models.mail_mail', 'oi.tests')
    ...
    @users('employee')
    @mute_logger('oi.addons.mail.models.mail_mail', 'oi.addons.mail.models.mail_message_schedule', 'oi.models.unlink')
    ...
    @mute_logger('oi.addons.mail.models.mail_mail', 'oi.addons.mail.models.mail_message_schedule')
    ...
    @mute_logger('oi.addons.base.models.ir_model', 'oi.addons.mail.models.mail_mail')
