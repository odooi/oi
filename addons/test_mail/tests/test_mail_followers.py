...
from oi.addons.mail.models.mail_mail import _UNFOLLOW_REGEX
...
from oi.tools import email_normalize, mail, mute_logger, parse_contact_from_email
...
class UnfollowFromEmailTest(MailCommon, HttpCase):
    ...
    @mute_logger('oi.addons.base.models', 'oi.addons.mail.controllers.mail', 'oi.http', 'oi.models')
    ...
    @mute_logger('oi.addons.mail.controllers.mail', 'oi.models', 'oi.http')
