...
from oi.addons.mail.wizard.mail_compose_message import MailComposer
from oi.addons.test_mail.models.test_mail_models import MailTestTicket
from oi.addons.test_mail.tests.common import TestRecipients
from oi.fields import Datetime as FieldDatetime
from oi.exceptions import AccessError, UserError
from oi.tests import Form, tagged, users
from oi.tools import email_normalize, mute_logger, formataddr
...
class TestComposerInternals(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('oi.tests', 'oi.addons.mail.models.mail_mail', 'oi.models.unlink')
    ...
    @mute_logger('oi.tests', 'oi.addons.base.models.ir_rule', 'oi.addons.mail.models.mail_mail', 'oi.models.unlink')
...
class TestComposerResultsComment(TestMailComposer, CronMixinCase):
    ...
    @users('employee')
    @mute_logger('oi.models.unlink', 'oi.addons.mail.models.mail_mail', 'oi.addons.mail.models.mail_message_schedule')
...
class TestComposerResultsMass(TestMailComposer):
    ...
    @users('employee')
    @mute_logger('oi.models.unlink', 'oi.addons.mail.models.mail_mail')
