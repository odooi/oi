...
import { beforeEach, describe, test, expect } from "@oi/hoot";
import { queryOne, waitUntil } from "@oi/hoot-dom";
...
test.skip("Attachment view / chatter popout across multiple records test", async () => {
    // skip because test has race conditions: https://runbot.odoodooi.com/oi/runbot.build.error/109795
    const pyEnv = await startServer();
