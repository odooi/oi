...
To: {to}
cc: {cc}
Received: by mail1.odoodooi.com (Postfix, from userid 10002)
...
Received: from mail-ie0-f173.google.com (mail-ie0-f173.google.com [209.85.223.173])
    ...
    for <raoul@oi.fr>; Fri, 23 Aug 2013 13:17:55 +0200 (CEST)
...
Received: by mail1.grosbedon.com (Postfix, from userid 10002)
    id E8166BFACA; Fri, 23 Aug 2013 13:18:01 +0200 (CEST)
From: "Bruce Wayne" <bruce@waynepluss.com>
Content-Type: multipart/alternative;
...
From: "Bruce Wayne" <bruce@waynepluss.com>
Subject: test
Message-ID: <c0c20fdd-a38e-b296-865b-d9232bf30ce5@odoodooi.com>
...
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:52.0) Gecko/20100101
 Thunderbird/52.6.0
MIME-Version: 1.0
In-Reply-To: <f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@odoodooi.com>
Content-Type: multipart/mixed;
...
Delivered-To: anon2@gmail1.odoodooi.com
...
ARC-Authentication-Results: i=1; mx.google.com;
       dkim=pass header.i=@odoodooi.com header.s=mail header.b=MCzhjB9b;
       spf=pass (google.com: domain of soup@odoodooi.com designates 149.202.180.44 as permitted sender) smtp.mailfrom=soup@odoodooi.com;
       dmarc=pass (p=NONE sp=NONE dis=NONE) header.from=odoodooi.com
Return-Path: <soup@odoodooi.com>
Received: from mail2.odoodooi.com (mail2.odoodooi.com. [149.202.180.44])
        by mx.google.com with ESMTPS id y4si4279200wmy.148.2018.03.05.01.19.22
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Mon, 05 Mar 2018 01:19:23 -0800 (PST)
Received-SPF: pass (google.com: domain of soup@odoodooi.com designates 149.202.180.44 as permitted sender) client-ip=149.202.180.44;
...
Received: from [10.10.31.24] (unknown [91.183.114.50])
	...
	by mail2.odoodooi.com (Postfix) with ESMTPSA id 7B571A4085
	for <what@odoodooi.com>; Mon,  5 Mar 2018 10:19:21 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=odoodooi.com; s=mail;
...
To: what@odoodooi.com
From: Soup <soup@odoodooi.com>
Subject: =?UTF-8?Q?Soupe_du_jour_:_Pois_cass=c3=a9s?=
Message-ID: <a05d8334-7b7c-df68-c96a-4a88ed19f31b@odoodooi.com>
...
X-Spam-Checker-Version: SpamAssassin 3.4.0 (2014-02-07) on mail2.odoodooi.com
...
Chaussée de Namur, 40
B-1367 Grand Rosière
Web: <a class="moz-txt-link-freetext" href="http://www.odoodooi.com">http://www.odoodooi.com</a> </pre>
  </body>
</html>
...
Delivered-To: oi+82240-account.invoice-19177@mycompany.example.com
...
MIME-Version: 1.0
Message-Id: {msg_id}
references: <1571814481.189281940460205.799582441238467-oi-19177-account.invoice@mycompany.example.com>
Subject: Test
...
X-Oi-Objects: account.invoice-19177
...
In-Reply-To: <829228111124527.1111111602.256611118262939-oi-129-xxxx.xxxx@ip-1-1-1-1>
References: <867911111953277.1523671337.187951111160400-oi-129-xxxx.xxxx@ip-1-1-1-1>
 <867911111953277.1523671337.256611118262939-oi-129-xxxx.xxxx@ip-1-1-1-1>
...
.256660938262939-oi-129-xxxx.xxxx@ip-1-1-1-1" type=3D"cite"=
 class=3D"cite2">
...
.com" style=3D"text-decoration:none; color: white;">
                      ...
                      <tr>
                        <td align=3D"center">
                            Powered by <a href=3D"https://www.odoodooi.com">Odo=
o</a>.
                        </td>
                      </tr>
                    </tbody>
...
MIME-Version: 1.0
Message-Id: {extra}
references: <670034078674109.1555335454.587288856506348-oi-32-project.task@aaa>
Subject: Re: Test
...
X-Oi-Objects: project.project-3, ,project.task-32
...
Received: by mailserver.odoodooi.com (Postfix)
...
MIME-Version: 1.0
Content-Type: multipart/report; report-type=delivery-status;
        boundary="DFFDC17AA03.1673346179/mailserver.odoodooi.com"
Message-Id: <40230110102259.EA0B917B8E4@mailserver.odoodooi.com>
Content-Transfer-Encoding: 7bit
Delivered-To: {delivered_to}
Return-Path: <>

--DFFDC17AA03.1673346179/mailserver.odoodooi.com
Content-Description: Notification
Content-Type: text/plain; charset=utf-8
Content-Transfer-Encoding: quoted-printable
...
Reporting-MTA: dns; mailserver.odoodooi.com
X-Postfix-Queue-ID: DFFDC17AA03
X-Postfix-Sender: rfc822; bounce@xxx.odoodooi.com
...
Return-Path: <bounce@xxx.odoodooi.com>
Received: from eupp00.odoodooi.com (00.72.79.34.bc.googleusercontent.com [34.=
79.72.00])
        by mailserver.odoodooi.com (Postfix) with ESMTPS id DFFDC17AA03;
        Tue, 10 Jan 2023 11:22:57 +0100 (CET)
DKIM-Signature: v=3D1; a=3Drsa-sha256; c=3Dsimple/simple; d=3Dxxx.be;
        s=3Doi; t=3D1673346178;
...
Message-Id: <368396033905967.1673346177.695352554321289-oi-11-sale.o=
rder@eupp00>
references: <792105153140463.1673746527.352018594741821-oi-11-sale.o=
rder@xxx.odoodooi.com> <368396033905967.1673346177.695352554321289-oi-11=
-sale.order@eupp00>
Subject: Thi is a SO (Ref SO/11)
From: info@xxx.odoodooi.com
Reply-To: "SO/11" <catchall@xxx.odoodooi.com=
>
To: "rdesfrdgtfdrfesd@outlook.com" <rdesfrdgtfdrfesd@outlook.com>
Date: Tue, 29 Feb 2023 06:09:06 -0000
X-Oi-Objects: sale.order-11
MIME-Version: 1.0
...
To: "Thai Oi User" <thai-user@odoodooi.com>
