...
from oi.addons.sale_management.tests.common import SaleManagementCommon
from oi.addons.sale_pdf_quote_builder.controllers.quotation_document import (
...
class TestPDFQuoteBuilder(BaseUsersCommon, SaleManagementCommon):
    ...
    def test_quotation_document_upload_no_template(self):
        ...
        if 'website' not in self.env:
            ...
            from oi.addons.website.tools import MockRequest  # noqa: PLC0415
