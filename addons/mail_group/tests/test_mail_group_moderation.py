...
from oi.addons.mail_group.tests.data import GROUP_TEMPLATE
from oi.addons.mail_group.tests.common import TestMailListCommon
...
class TestMailGroupModeration(TestMailListCommon):
    ...
    @mute_logger('oi.models.unlink', 'oi.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('oi.addons.base.models.ir_rule', 'oi.addons.base.models.ir_model')
...
class TestModeration(TestMailListCommon):
    ...
    @mute_logger('oi.addons.mail.models.mail_thread', 'oi.addons.mail_group.models.mail_group_message')
    @users('employee')
    ...
    @mute_logger('oi.addons.mail.models.mail_thread', 'oi.addons.mail_group.models.mail_group_message', 'oi.models.unlink')
    @users('employee')
    ...
    @mute_logger('oi.addons.mail_group.models.mail_group')
    @users('employee')
