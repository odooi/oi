...
from oi.addons.auth_signup.models.res_users import SignupError
from oi.addons.web.controllers.home import ensure_db, Home, SIGN_UP_REQUEST_PARAMS, LOGIN_SUCCESSFUL_PARAMS
from oi.addons.base_setup.controllers.main import BaseSetup
