...
from oi.addons.sales_team.tests.common import TestSalesMC
from oi.tests.common import users, TransactionCase
...
class TestCornerCases(TransactionCase):
    ...
    def test_unicity(self):
        ...
        with self.assertRaises(exceptions.UserError), mute_logger('oi.sql_db'):
