...
from oi import _, release
from oi.tools import cleanup_xml_node
...
class L10nHuEdiConnection:
    ...
    def do_token_exchange(self, credentials):
        ...
        try:
            # Convert into a naive UTC datetime, since Oi can't store timezone-aware datetimes
    ...
    def _get_header_values(self, credentials, invoice_hashs=None):
        ...
        request_id = 'OI' + secrets.token_hex(13)
        ...
        return {
            ...
            'softwareName': 'Oi Plus',
            'softwareOperation': 'ONLINE_SERVICE',
            'softwareMainVersion': oi_version,
            'softwareDevName': 'Oi SA',
            'softwareDevContact': 'andu@odoodooi.com',
