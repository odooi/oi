...
from oi.addons.website_sale_collect.tests.common import ClickAndCollectCommon
from oi.addons.website_sale_stock.tests.common import WebsiteSaleStockCommon
...
class TestDeliveryCarrier(ClickAndCollectCommon, WebsiteSaleStockCommon):
    ...
    def test_in_store_get_close_locations_returned_data(self):
        ...
        with patch(
            'oi.addons.base_geolocalize.models.res_partner.ResPartner.geo_localize',
            return_value=True
