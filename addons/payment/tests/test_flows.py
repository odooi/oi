...
from oi.tests import tagged, JsonRpcException
from oi.tools import mute_logger

from oi.addons.payment.controllers.portal import PaymentPortal
...
class TestFlows(PaymentHttpCommon):
    ...
    def test_transaction_wrong_flow(self):
        ...
        with mute_logger("oi.http"), self.assertRaises(
            JsonRpcException,
            msg='oi.exceptions.UserError: The payment should either be direct, with redirection, or made by a token.',
        ):
    ...
    def test_transaction_wrong_token(self):
        ...
        with mute_logger('oi.http'), self.assertRaises(JsonRpcException, msg='oi.exceptions.ValidationError: The access token is invalid.'):
