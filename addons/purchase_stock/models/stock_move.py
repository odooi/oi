...
from oi.tools.float_utils import float_round, float_is_zero, float_compare
...
class StockMove(models.Model):
    ...
    def _get_price_unit(self):
        ...
        if order.currency_id != order.company_id.currency_id:
            ...
            # https://github.com/oi/oi/blob/2f789b6863407e63f90b3a2d4cc3be09815f7002/addons/stock/models/stock_move.py#L36
    ...
    def _get_valuation_price_and_qty(self, related_aml, to_curr):
        ...
        if float_is_zero(valuation_total_qty, precision_rounding=related_aml.product_uom_id.rounding or related_aml.product_id.uom_id.rounding):
            raise UserError(
                _('Oi is not able to generate the anglo saxon entries. The total valuation of %s is zero.',
