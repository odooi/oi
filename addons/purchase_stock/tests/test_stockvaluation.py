...
import oi
from oi import fields, exceptions, Command
from oi.tests import Form
from oi.tests.common import TransactionCase, tagged
from oi.addons.account.tests.common import AccountTestInvoicingCommon
from oi.tools import DEFAULT_SERVER_DATETIME_FORMAT
from oi.addons.stock.tests.common import TestStockCommon
...
class TestStockValuationWithCOA(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        ...
        old_action_post = oi.addons.account.models.account_move.AccountMove.action_post
        old_create = oi.models.BaseModel.create
        ...
        post_patch = patch('oi.addons.account.models.account_move.AccountMove.action_post', new_action_post)
        create_patch = patch('oi.models.BaseModel.create', new_create)
    ...
    def test_realtime_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        def _today(*args, **kwargs):
            return date_po
        patchers = [
            patch('oi.fields.Date.context_today', _today),
        ]
    ...
    def test_average_realtime_with_delivery_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        patchers = [
            patch('oi.fields.Date.context_today', _today),
            patch('oi.fields.Datetime.now', _now),
        ]
    ...
    def test_incoming_with_negative_qty(self):
        ...
        # it is negative qty transfer so Oi will create delivery instead of receipt.
