...
from oi import _, api, exceptions, fields, models
from oi.http import request
from oi.tools import DEFAULT_SERVER_DATETIME_FORMAT, safe_eval
...
class BaseAutomation(models.Model):
    ...
    def _get_filter_domain_fields(self):
        ...
        # see: https://github.com/oi/oi/pull/189772#issuecomment-2548804283
