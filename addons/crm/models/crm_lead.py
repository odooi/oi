...
from oi.addons.mail.tools import mail_validation
from oi.addons.phone_validation.tools import phone_validation
from oi.exceptions import UserError, AccessError
from oi.osv import expression
from oi.tools.translate import _
from oi.tools import date_utils, email_split, is_html_empty, groupby, parse_contact_from_email, SQL
from oi.tools.misc import get_lang
...
PLS_COMPUTE_BATCH_STEP = 50000  # oi.models.PREFETCH_MAX = 1000 but larger cluster can speed up global computation
