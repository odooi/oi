...
from oi.addons.crm.tests.common import TestCrmCommon
from oi.addons.iap.tools import iap_tools
from oi.tests.common import tagged, users
...
class TestCRMLead(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.emails_provider_generic = {
            ...
            ('fp@odoodooi.com', 'fp@odoodooi.com'),
            ('fp.alias@mail.odoodooi.com', 'fp.alias@mail.odoodooi.com'),
        }
        cls.emails_provider_company = {
            ('robert.poilvert@mycompany.com', 'mycompany.com'),
            ('fp@subdomain.odoodooi.com', 'subdomain.odoodooi.com'),
        }
        ...
        cls.lead_generic_email_dupes = cls.env['crm.lead'].create([
            ...
            {
                'email_from': '"Fabulous Fab" <fp@OI.COM>',
                'name': 'Dupe1 of fp@odoodooi.com (same email)',
                'type': 'lead',
            },
            {
                'email_from': 'FP@odoodooi.com',
                'name': 'Dupe2 of fp@odoodooi.com (same email)',
                'type': 'lead',
            },
            # phone_sanitized based
            {
                'email_from': 'not.fp@not.odoodooi.com',
                'name': 'Dupe3 of fp@odoodooi.com (same phone sanitized)',
                'phone': '+1 202 555 0123',
                'type': 'lead',
            },
            {
                ...
                'name': 'Dupe4 of fp@odoodooi.com (same phone sanitized)',
                'type': 'lead',
            },
            # same commercial entity
            {
                'name': 'Dupe5 of fp@odoodooi.com (same commercial entity)',
                'partner_id': cls.test_partners[1].id,
            },
            {
                'name': 'Dupe6 of fp@odoodooi.com (same commercial entity)',
        ...
        cls.lead_generic_email_notdupes = cls.env['crm.lead'].create([
            ...
            {
                'email_from': 'not.fp@odoodooi.com',
                'name': 'NotADupe1',
                'type': 'lead',
            },
        ])
    ...
    def test_assert_initial_values(self):
        ...
        self.assertEqual(lead_generic.email_domain_criterion, 'fp@odoodooi.com')
        self.assertEqual(lead_generic.email_normalized, 'fp@odoodooi.com')
