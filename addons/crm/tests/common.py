...
from oi.addons.crm.models.crm_lead import PARTNER_ADDRESS_FIELDS_TO_SYNC
from oi.addons.mail.tests.common import MailCase, mail_new_test_user
...
from oi.fields import Datetime
from oi import models, tools
...
class TestLeadConvertCommon(TestCrmCommon):
    ...
    def setUpClass(cls):
        ...
        cls.crm_lead_dt_patcher = patch('oi.addons.crm.models.crm_lead.fields.Datetime', wraps=Datetime)
