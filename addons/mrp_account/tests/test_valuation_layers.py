...
from oi.addons.stock_account.tests.test_stockvaluationlayer import TestStockValuationCommon
from oi.addons.stock_account.tests.test_stockvaluation import TestStockValuationBase
