...
from oi.addons.payment.tests.common import PaymentCommon
from oi.addons.sale.tests.common import SaleCommon
from oi.addons.website.tools import MockRequest
from oi.addons.website_sale.controllers.delivery import Delivery
    ...
    def test_controller_change_carrier_when_transaction(self):
        with MockRequest(self.env, website=self.website):
            ...
            with self.assertRaises(UserError), patch(
                'oi.addons.website_sale.models.website.Website.sale_get_order',
                return_value=order,
