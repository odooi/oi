...
from oi.addons.base.tests.common import BaseUsersCommon
from oi.addons.product.tests.common import ProductAttributesCommon
from oi.addons.website.tools import MockRequest
from oi.addons.website_sale.controllers.combo_configurator import (
    WebsiteSaleComboConfiguratorController,
)
from oi.addons.website_sale.controllers.main import WebsiteSale
from oi.addons.website_sale.controllers.payment import PaymentPortal
from oi.addons.website_sale.models.product_template import ProductTemplate
...
class TestWebsiteSaleCart(BaseUsersCommon, ProductAttributesCommon, WebsiteSaleCommon):
    ...
    def test_checkout_no_delivery_method_available(self):
        ...
        with (MockRequest(self.product.with_user(portal_user).env, website=website), patch(
            'oi.addons.website_sale.models.sale_order.SaleOrder._get_preferred_delivery_method',
