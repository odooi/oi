...
from oi import http
from oi.addons.website.models.website import Website
import oi.tests
...
class TestWebsiteSession(HttpCaseWithUserDemo):
    ...
    def test_02_inactive_session_lang(self):
        ...
        current_website_id = self.env["website"]._get_current_website_id(oi.tests.HOST)
        self.env["website"].browse(current_website_id).domain = oi.tests.HOST
