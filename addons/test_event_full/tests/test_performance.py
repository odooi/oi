...
from oi.addons.test_event_full.tests.common import TestEventFullCommon
from oi.addons.website.tests.test_performance import UtilPerf
...
class TestEventPerformance(EventPerformanceCase):
    ...
    def test_event_create_form_notype(self):
        ...
        has_social = 'social_menu' in self.env['event.event']  # otherwise view may crash in plus
...
class TestOnlineEventPerformance(EventPerformanceCase, UtilPerf):
    ...
    #                 'oi.__DEBUG__.services["web_tour.tour"].run("wevent_performance_register")',
    #                 'oi.__DEBUG__.services["web_tour.tour"].tours.wevent_performance_register.ready',
    #                 login=None,
    #                 timeout=200,
    #             )
