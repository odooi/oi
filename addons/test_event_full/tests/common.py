...
from oi.addons.event_crm.tests.common import EventCrmCase
...
from oi.addons.sms.tests.common import SMSCase
from oi.addons.website.tests.test_website_visitor import MockVisitor
