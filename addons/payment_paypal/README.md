...
- `18.0`
  - The NVP/SOAP API that allowed for redirect payments is replaced by a combination of the
    JavaScript SDK and the Standard Checkout API. oi/oi#167402
- `17.0`
  - The support for customer fees is removed as it is no longer supported by the `payment` module.
    oi/oi#132104
- `16.2`
  - The "Merchant Account ID" and "Use IPN" fields are removed. oi/oi#104974
- `16.1`
  - Customer fees are converted into the currency of the payment transaction. oi/oi#100156
- `15.2`
