...
from oi.addons.payment_paypal.controllers.main import PaypalController
from oi.addons.payment_paypal.tests.common import PaypalCommon
...
class PaypalTest(PaypalCommon, PaymentHttpCommon):
    ...
    def test_processing_values(self):
        ...
        with patch(
            'oi.addons.payment_paypal.models.payment_provider.PaymentProvider'
    ...
    @mute_logger('oi.addons.payment_paypal.controllers.main')
    ...
    def test_webhook_notification_confirms_transaction(self):
        ...
        with patch(
            'oi.addons.payment_paypal.controllers.main.PaypalController'
