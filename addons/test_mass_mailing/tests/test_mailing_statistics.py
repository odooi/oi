...
from oi.addons.test_mass_mailing.data.mail_test_data import MAIL_TEMPLATE
from oi.addons.test_mass_mailing.tests.common import TestMassMailCommon
...
class TestMailingStatistics(TestMassMailCommon):
    ...
    @mute_logger('oi.addons.mass_mailing.models.mailing', 'oi.addons.mail.models.mail_mail', 'oi.addons.mail.models.mail_thread')
    def test_mailing_statistics(self):
        ...
        self.gateway_mail_trace_click(mailing, target_records[0], 'https://www.oi.be')
        self.gateway_mail_trace_click(mailing, target_records[2], 'https://www.oi.be')
        self.gateway_mail_trace_click(mailing, target_records[3], 'https://www.oi.be')
