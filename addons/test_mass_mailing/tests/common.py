...
from oi.addons.mass_mailing_sms.tests.common import MassSMSCommon
...
<t t-set="httpurl" t-value="'https://www.oi.eu'"/>f
<span>Website0: <a id="url0" t-attf-href="https://www.oi.tz/my/{{object.name}}">https://www.oi.tz/my/<t t-out="object.name"/></a></span>
<span>Website1: <a id="url1" href="https://www.oi.be">https://www.oi.be</a></span>
...
<span>Email: <a id="url7" href="mailto:test@odoodooi.com">test@odoodooi.com</a></span>
<p>Stop spam ? <a id="url8" role="button" href="/unsubscribe_from_list">Ok</a></p>
        ...
        cls.mailing_sms = cls.env['mailing.mailing'].with_user(cls.user_marketing).create({
            ...
            'body_plaintext': 'Dear {{object.display_name}} this is a mass SMS with two links http://www.odoodooi.com/smstest and http://www.odoodooi.com/smstest/{{object.id}}',
            'sms_force_send': True,
