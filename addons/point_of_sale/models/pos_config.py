...
from oi import api, fields, models, _, Command, tools, SUPERUSER_ID
from oi.http import request
from oi.exceptions import AccessError, ValidationError, UserError
from oi.tools import convert, SQL
...
class PosConfig(models.Model):
    ...
    sequence_id = fields.Many2one('ir.sequence', string='Order IDs Sequence', readonly=True,
        help="This sequence is automatically created by Oi but you can change it "
