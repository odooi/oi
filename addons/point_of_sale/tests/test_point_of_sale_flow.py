...
import oi
from oi import fields, tools
from oi.fields import Command
from oi.tools import float_compare, mute_logger, test_reports
from oi.tests import Form
from oi.addons.point_of_sale.tests.common import TestPointOfSaleCommon
