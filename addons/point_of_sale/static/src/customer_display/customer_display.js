import { Component, useEffect, useState, whenReady } from "@oi/owl";
import { OiLogo } from "@point_of_sale/app/generic_components/oi_logo/oi_logo";
...
export class CustomerDisplay extends Component {
    ...
    static components = { OiLogo, OrderWidget, Orderline, MainComponentsContainer };
    static props = [];
