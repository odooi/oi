...
import { closestElement } from "@web_editor/js/editor/oi-editor/src/OiEditor";
...
export class MassMailingWysiwyg extends Wysiwyg {
    ...
    setSnippetsMenuFolded(fold = true) {
        ...
        this.oiEditor.toolbar = this.toolbarEl;
        this.oiEditor.autohideToolbar = !!fold;
    ...
    async getSnippetsMenuClass() {
        ...
        const { MassMailingSnippetsMenu } = await oi.loader.modules.get('@mass_mailing/js/snippets.editor');
