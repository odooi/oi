...
import * as hoot from "@oi/hoot-dom";
import { pick } from "@web/core/utils/objects";

/**
 * @typedef TourStep
 * @property {"plus"|"community"|"mobile"|"desktop"|HootSelector[][]} isActive Active the step following {@link isActiveStep} filter
 * @property {string} [id]
...
export class TourStep {
    ...
    get active() {
        ...
        const standardKeyWords = ["plus", "community", "mobile", "desktop", "auto", "manual"];
        ...
        const edition =
            (session.server_version_info || "").at(-1) === "e" ? "plus" : "community";
        const checkEdition =
            isActiveArray.includes(edition) ||
            (!isActiveArray.includes("plus") && !isActiveArray.includes("community"));
