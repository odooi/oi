...
import { click, edit, keyDown, keyUp, press, queryOne } from "@oi/hoot-dom";
import { animationFrame, runAllTimers } from "@oi/hoot-mock";
import {
    contains,
    defineWebModels,
    mountWithCleanup,
...
test("Click on element with unique oi class", async () => {
...
test("Click on element with no unique oi class", async () => {
    await mountWithCleanup(
        `
        <div class="o_parent">
            <div class="o_child_1 click"></div>
...
test("Find the nearest oi class", async () => {
