# -*- coding: utf-8 -*-
from oi import models, fields, api, _, Command
from oi.exceptions import UserError, ValidationError
from oi.tools.misc import format_date, formatLang
from oi.tools import create_index
...
class AccountPayment(models.Model):
    ...
    payment_method_line_id = fields.Many2one('account.payment.method.line', string='Payment Method',
        ...
        help="Manual: Pay or Get paid by any method outside of Oi.\n"
