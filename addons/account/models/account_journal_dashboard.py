...
from oi import models, api, _, fields, Command, tools
from oi.exceptions import UserError
from oi.osv import expression
from oi.release import version
from oi.tools import DEFAULT_SERVER_DATE_FORMAT as DF, SQL
from oi.tools.misc import formatLang, format_date as oi_format_date, get_lang
      ...
      LEFT JOIN mail_activity_type act_type ON activity.activity_type_id = act_type.id
        ...
        for activity in self.env.cr.dictfetchall():
            act = {
                ...
                'date': oi_format_date(self.env, activity['date_deadline'])
            }
