...
from oi import api, fields, models, Command, _
from oi.exceptions import ValidationError, UserError, RedirectWarning
from oi.osv import expression
from oi.tools import frozendict, format_date, float_compare, format_list, Query
from oi.tools.sql import create_index, SQL
from oi.addons.web.controllers.utils import clean_action

from oi.addons.account.models.account_move import MAX_HASH_VERSION
...
class AccountMoveLine(models.Model):
    ...
    def _prepare_move_line_residual_amounts(self, aml_values, counterpart_currency, shadowed_aml_values=None, other_aml_values=None):
        ...
        def get_oi_rate(aml, other_aml, currency):
        ...
        if currency == company_currency \
            ...
            rate = get_oi_rate(aml, other_aml, counterpart_currency)
