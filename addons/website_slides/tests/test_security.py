...
from oi.addons.website_slides.tests import common
...
class TestAccess(common.SlidesCase):
    ...
    @mute_logger('oi.models', 'oi.addons.base.models.ir_rule')
...
class TestAccessFeatures(common.SlidesCase):
    ...
    @mute_logger('oi.models.unlink', 'oi.addons.base.models.ir_rule', 'oi.addons.base.models.ir_model')
...
class TestReview(common.SlidesCase, HttpCase):
    ...
    def test_channel_multiple_reviews(self):
        ...
        self.assertIn("oi.exceptions.ValidationError", res2.text)
