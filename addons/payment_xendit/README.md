...
- For `Card` payments, it renders a self-hosted payment form with regular (non-iframe) inputs and 
  ...
  token is saved in Oi. Other communications with Xendit are performed via server-to-server API
  calls.
...
- `17.4`
  - The support for tokenization via `Card` is added. oi/oi#158445
- `17.0`
  - The first version of the module is merged. oi/oi#141661
