...
from oi.tests import tagged, TransactionCase, Form
from oi.tools import mute_logger

from oi.addons.product.tests.common import ProductVariantsCommon, ProductAttributesCommon
...
class TestVariants(ProductVariantsCommon):
    ...
    def test_variants_pricelist_code(self):
        vendor = self.env['res.partner'].create({'name': 'Bidou', 'email': 'bidou@odoodooi.com'})
...
class TestVariantsExclusion(ProductAttributesCommon):
    ...
    def test_dynamic_variants_unarchive(self):
        ...
        with patch(
            'oi.addons.product.models.product_product.ProductProduct._filter_to_unlink',
