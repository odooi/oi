...
from oi.tools import float_compare, format_list, groupby
from oi.tools.image import is_image_size_above
from oi.tools.misc import unique
...
class ProductProduct(models.Model):
    ...
    def _unlink_or_archive(self, check_access=True):
        ...
        try:
            with self.env.cr.savepoint(), tools.mute_logger('oi.sql_db'):
                self.unlink()
        except Exception:
    ...
    def copy(self, default=None):
        ...
        returned.
        """
        # copy variant is disabled in https://github.com/oi/oi/pull/38303
