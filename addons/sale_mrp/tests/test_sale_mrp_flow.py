...
from oi.addons.stock_account.tests.test_anglo_saxon_valuation_reconciliation_common import ValuationReconciliationTestCommon
from oi.tests import common, Form
from oi.exceptions import UserError
from oi.tools import mute_logger, float_compare
from oi.addons.stock_account.tests.test_stockvaluation import _create_accounting_data
...
class TestSaleMrpFlow(TestSaleMrpFlowCommon):
    ...
    @mute_logger('oi.tests.common.onchange')
