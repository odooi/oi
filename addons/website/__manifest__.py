...

{
    ...
    'sequence': 20,
    'summary': 'Plus website builder',
    'website': 'https://www.odoodooi.com/app/website',
    'version': '1.0',
    'depends': [
        'digest',
        'web',
    ...
    'data': [
        ...
        'views/snippets/s_mega_menu_oi_menu.xml',
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            'website/static/src/libs/zoomoi/zoomoi.scss',
            'website/static/src/scss/website.scss',
            'website/static/src/scss/website_controller_page.scss',
            'website/static/src/scss/website.ui.scss',
            'website/static/src/libs/zoomoi/zoomoi.js',
        ...
        'website.assets_wysiwyg': [
            ...
            'website/static/src/js/editor/oi_editor.js',
        ],
