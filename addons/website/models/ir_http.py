...
from oi.osv.expression import FALSE_DOMAIN
from oi.addons.base.models.ir_http import EXTENSION_TO_WEB_MIMETYPES
from oi.addons.http_routing.models import ir_http
...
def get_request_website():
    ...
    ```
    from oi.addons.website.models import ir_http
...
class Http(models.AbstractModel):
    ...
    def _get_translation_frontend_modules_name(cls):
        ...
        installed = request.registry._init_modules.union(oi.conf.server_wide_modules)
