...
from oi.addons.web_editor.controllers.main import Web_Editor
from oi.fields import Command


@oi.tests.tagged('-at_install', 'post_install')
class TestUiCustomizeTheme(oi.tests.HttpCase):
...
class TestUiHtmlEditor(HttpCaseWithUserDemo):
    ...
    def test_code_editor_usable(self):
        ...
        url = '/oi/action-website.website_preview'
        self.start_tour(url, 'website_code_editor_usable', login='admin')


@oi.tests.tagged('external', '-standard', '-at_install', 'post_install')
...
@oi.tests.tagged('-at_install', 'post_install')
class TestUiTranslate(oi.tests.HttpCase):
...
class TestUi(oi.tests.HttpCase):

    def test_01_admin_tour_homepage(self):
        self.start_tour("/oi", 'homepage', login='admin')
    ...
    def test_10_website_conditional_visibility(self):
        ...
        self.start_tour('/oi', 'conditional_visibility_2', login='admin')
    ...
    def test_19_website_page_options(self):
        self.start_tour("/oi", "website_page_options", login="admin")
    ...
    def test_21_website_start_cloned_snippet(self):
        self.start_tour('/oi', 'website_start_cloned_snippet', login='admin')

    def test_22_website_gray_color_palette(self):
        self.start_tour('/oi', 'website_gray_color_palette', login='admin')
    ...
    def test_26_website_media_dialog_icons(self):
        self.env.ref('website.default_website').write({
            'social_twitter': 'https://twitter.com/Oi',
            'social_facebook': 'https://www.facebook.com/Oi',
            'social_linkedin': 'https://www.linkedin.com/company/oi',
            'social_youtube': 'https://www.youtube.com/user/Oionline',
            'social_github': 'https://github.com/oi',
            'social_instagram': 'https://www.instagram.com/explore/tags/oi/',
            'social_tiktok': 'https://www.tiktok.com/@oi',
        })
        self.start_tour("/", 'website_media_dialog_icons', login='admin')

    def test_27_website_clicks(self):
        self.start_tour('/oi', 'website_click_tour', login='admin')
