...
registerWebsitePreviewTour('snippet_social_media', {
    ...
    ...addNewSocialNetwork(9, 8, 'https://instagr.am/oi.official/'),
    {
        ...
        trigger: ":iframe .s_social_media" +
                 ...
                 ":has(a:eq(8)[href='https://instagr.am/oi.official/']:has(i.fa-instagram))",
    },
    ...
    },
    {
        ...
        run: "edit https://instagram.com/oi.official/ && click body",
    },
    ...preventRaceConditionStep,
    ...clickOnSave(),
    ...clickOnEditAndWaitEditMode(),
