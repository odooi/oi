...
registerWebsitePreviewTour("website_form_editor_tour", {
    ...
    ...addExistingField('email_cc', 'text', 'Test conditional visibility', false, {visibility: CONDITIONALVISIBILITY, condition: 'oi'}),
    {
...

    {
        ...
        run: () => {
            ...
            wysiwyg.oiEditor.historyStep(true);
        },
    },
