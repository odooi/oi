...
import { boundariesIn, setSelection, nodeSize } from '@web_editor/js/editor/oi-editor/src/utils/utils';
...
registerWebsitePreviewTour('link_tools', {
    ...
    {
        content: "Type the link URL odoodooi.com",
        trigger: '#toolbar:not(.oe-floating) #o_link_dialog_url_input',
        run: 'edit odoodooi.com',
    },
    clickOnImgStep,
    {
        content: "Select the newly created link",
        trigger: ':iframe #wrap .s_text_image a[href="http://odoodooi.com"]:contains("odoodooi.com")',
        run() {
    ...
    },
    {
        ...
        trigger: ':iframe .popover:contains("http://odoodooi.com") a .fa-chain-broken',
        run: 'click',
    },
    {
        content: "Check that the link was removed",
        trigger: ':iframe #wrap .s_text_image p:contains("Go to oi:"):not(:has(a))',
    },
    // Recreate the link.
    {
    ...
    {
        content: "Click on the newly created link",
        trigger: ':iframe .s_text_image a[href="http://odoodooi.com"]:contains("odoodooi.com")',
        run: "click",
    },
    {
        content: "Change content (editing the label input) to oi website_2",
        trigger: '#o_link_dialog_label_input:value(odoodooi.com)',
        run: 'edit oi website_2',
    },
    {
        content: "Change content (editing the DOM) to oi website",
        trigger: ':iframe .s_text_image a[href="http://odoodooi.com"]:contains("oi website_2")',
        run: 'editor oi website',
    },
    clickOnImgStep,
    {
        content: "Click again on the link",
        trigger: ':iframe .s_text_image a[href="http://odoodooi.com"]:contains("oi website")',
        run: "click",
    },
    {
        content: "Check that the label input contains the new content",
        trigger: '#o_link_dialog_label_input:value(oi website)',
    },
    {
    ...
    ...clickOnEditAndWaitEditMode(),
    {
        content: "The new link content should be oi website and url oi.be",
        trigger: ':iframe .s_text_image a[href="http://oi.be"]:contains("oi website")',
        run: "click",
    },
    {
        content: "The new link content should be oi website and url oi.be",
    ...
    ...clickOnSave(),
    {
        ...
        trigger: ':iframe .s_text_image a.btn.btn-secondary[href="http://oi.be"]:contains("oi website")',
    },
    // 4. Add link on image.
    ...clickOnEditAndWaitEditMode(),
    ...insertSnippet({
    ...
    },
    {
        ...
        // TODO: remove && click
        run: "edit odoodooi.com && click(we-title:contains(Your URL))",
    },
    {
    ...
    },
    {
        ...
        trigger: ':iframe .popover div a:contains("http://odoodooi.com")',
    },
    ...clickOnSave(),
    {
    ...
    clickOnElement("card's text", ":iframe header .s_mega_menu_cards span"),
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run: "edit https://www.odoodooi.com",
    },
    {
        content: "Check nothing is lost",
        trigger: ":iframe header .s_mega_menu_cards a[href='https://www.odoodooi.com']:has(img):has(h4):has(span)",
    },
    ...
    },
    {
        ...
        trigger: ':iframe #wrap .s_text_image p',
        run: "editor odoodooi.com",
    },
    {
        content: "Select text",
        trigger: ':iframe #wrap .s_text_image p:contains(odoodooi.com)',
        run() {
    ...
    clickOnImgStep,
    {
        ...
        trigger: ":iframe .s_text_image p a[href='http://odoodooi.com']:contains('odoodooi.com')",
    },
    {
        content: "Click on link to open the link tools",
        trigger: ":iframe .s_text_image p a[href='http://odoodooi.com']",
        run: "click",
    },
    // 8. Check that http links are not coerced to https and vice-versa.
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run() {
            // TODO: update the tour to use helpers.edit("https://odoodooi.com")
            // To see what happens with edit, add `pause:true` to the previous step
            // and type yourself https://odoodooi.com in #o_link_dialog_url_input
            // The label will be ohttps://
            this.anchor.value = "https://odoodooi.com";
            this.anchor.dispatchEvent(new InputEvent("input", { bubbles: true }));
        }
    },
    {
        content: "Check that link was updated",
        trigger: ":iframe .s_text_image p a[href='https://odoodooi.com']:contains('odoodooi.com')",
    },
    {
    ...
    },
    {
        ...
        trigger: "#o_link_dialog_url_input",
        run() {
            // TODO: update the tour to use helpers.edit("http://odoodooi.com")
            this.anchor.value = "http://odoodooi.com";
            this.anchor.dispatchEvent(new InputEvent("input", { bubbles: true }));
        }
    },
    {
    ...
    // TODO this step which was added by https://github.com/oi/odoodooi.commit/9fc283b514d420fdfd66123845d9ec3563572692
