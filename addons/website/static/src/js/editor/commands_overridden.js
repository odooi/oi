...
import { UNMERGEABLE_SELECTORS } from "@web_editor/js/editor/oi-editor/src/utils/sanitize";
 ...
 */
HTMLElement.prototype.oDeleteBackwardOiEditor = HTMLElement.prototype.oDeleteBackward;
HTMLElement.prototype.oDeleteBackward = function (offset, alreadyMoved = false, offsetLimit) {
    ...
    this.oDeleteBackwardOiEditor(...arguments);
};
