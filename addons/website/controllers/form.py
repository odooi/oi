...
from oi import http, SUPERUSER_ID
from oi.addons.base.models.ir_qweb_fields import nl2br, nl2br_enclose
from oi.http import request
from oi.tools import plaintext2html
from oi.exceptions import AccessDenied, ValidationError, UserError
from oi.tools.misc import hmac, consteq
