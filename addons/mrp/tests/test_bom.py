...
from oi import exceptions, Command, fields
from oi.tests import Form
from oi.addons.mrp.tests.common import TestMrpCommon
from oi.tests.common import HttpCase, tagged, freeze_time
from oi.tools import float_compare, float_round, float_repr
...
class TestBoM(TestMrpCommon):
    ...
    def test_cycle_on_bom_sequencing(self):
        ...
        # (see oi/addons/web/controllers/main.py:1352)
...
class TestTourBoM(HttpCase):
    ...
    def test_mrp_bom_product_catalog(self):
        ...
        url = f'/oi/action-mrp.mrp_bom_form_action/{self.bom.id}'
    ...
    def test_manufacture_from_bom(self):
        ...
        """
        url = '/oi/action-mrp.mrp_bom_form_action'
