...
import oi
from oi import api, models, exceptions, tools, http
from oi.addons.base.models import ir_http
from oi.addons.base.models.ir_http import RequestUID
from oi.addons.base.models.ir_qweb import keep_query, QWebException
from oi.addons.base.models.res_lang import LangData
from oi.exceptions import AccessError, MissingError
    ...
    def _pre_dispatch(cls, rule, args):
        ...
        if request.is_frontend_multilang:
            ...
            if request.httprequest.method in ('GET', 'HEAD'):
                ...
                except oi.exceptions.MissingError:
