...
- `16.1`
  - The "Authorize Currency" field is replaced by the generic "Currencies" field of `payment`.
    oi/oi#101018
- `16.0`
  - Archiving a token no longer deactivates the related payment method on Authorize. oi/oi#93774
- `15.4`
  - The support for full refunds is added. oi/oi#92279
- `15.0`
  - Support for ACH payments is added. oi/oi#75289
- `14.3`
