...
from oi import _, models
from oi.exceptions import UserError, ValidationError

from oi.addons.payment import utils as payment_utils
from oi.addons.payment_authorize.models.authorize_request import AuthorizeAPI
from oi.addons.payment_authorize.const import PAYMENT_METHODS_MAPPING, TRANSACTION_STATUS_MAPPING
...
class PaymentTransaction(models.Model):
    ...
    def _send_refund_request(self, amount_to_refund=None):
        ...
        if tx_status in TRANSACTION_STATUS_MAPPING['voided']:
            ...
            # create a refund tx on Oi to reflect the move of the funds.
