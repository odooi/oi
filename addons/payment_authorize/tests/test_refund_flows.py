...
from oi.addons.payment_authorize.tests.common import AuthorizeCommon
...
class TestRefundFlows(AuthorizeCommon):
    ...
    def test_refunding_voided_tx_cancels_it(self):
        ...
        with patch(
            'oi.addons.payment_authorize.models.authorize_request.AuthorizeAPI'
    ...
    @mute_logger('oi.addons.payment_authorize.models.payment_transaction')
    def test_refunding_authorized_tx_voids_it(self):
        ...
        with patch(
            ...
            'oi.addons.payment_authorize.models.authorize_request.AuthorizeAPI.void'
        ) as void_mock, patch(
    ...
    def test_refunding_captured_tx_refunds_it_and_creates_refund_tx(self):
        ...
        create a refund transaction on Oi. """
        source_tx = self._create_transaction('direct', state='done')
        with patch(
            'oi.addons.payment_authorize.models.authorize_request.AuthorizeAPI'
            '.get_transaction_details',
            ...
            'oi.addons.payment_authorize.models.authorize_request.AuthorizeAPI.refund'
