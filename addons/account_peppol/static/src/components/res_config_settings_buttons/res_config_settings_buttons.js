...
import { Component, markup, useState } from "@oi/owl";
...
class PeppolSettingsButtons extends Component {
    ...
    showConfirmation(warning, methodName) {
        ...
        const confirmMessage = _t("You will not be able to send or receive Peppol documents in Oi anymore. Are you sure you want to proceed?");
