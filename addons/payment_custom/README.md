...
- `16.1`
  - The default payment instructions message of Wire Transfer can be recomputed at any time after
    installation of the module. oi/oi#103903
- `16.0`
  - The `custom_mode` field is added to distinguish custom payment modes from other payment
    ...
    oi/oi#99400
  - The module is no longer automatically installed with the `payment` module. oi/oi#99400
  - The module is renamed from `payment_transfer` to `payment_custom`. oi/oi#99400
