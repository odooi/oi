...
export class CollaborationSelectionAvatarPlugin extends Plugin {
    ...
    static dependencies = ["history", "position", "localOverlay", "collaborationOi"];
    resources = {
        /** Handlers */
    ...
    /**
     * @param {import("./collaboration_oi_plugin").CollaborationSelection} selection
     */
    ...
    drawPeerAvatar(selectionInfo) {
        ...
        const peerMetadata = this.dependencies.collaborationOi.getPeerMetadata(peerId);
        if (!peerMetadata) {
            return;
        }
