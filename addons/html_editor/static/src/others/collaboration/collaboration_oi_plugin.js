...
/**
 * @typedef { Object } CollaborationOiShared
 * @property { CollaborationOiPlugin['getPeerMetadata'] } getPeerMetadata
 */

export class CollaborationOiPlugin extends Plugin {
    static id = "collaborationOi";
            ...
            onNotification: async (notification) => {
                ...
                switch (notificationName) {
                    ...
                    case "ptp_disconnect":
                        ...
                        // todo: to implement
                        // this.oiEditor.multiselectionRemove(fromPeerId);
                        break;
