...
import { click, hover, queryAll, queryOne, waitFor, waitForNone } from "@oi/hoot-dom";
...
test("Toolbar should not overflow scroll container", async () => {
    ...
    const editable = queryOne(".oi-editor-editable");
...
test("Table column control should always be displayed on top of the table", async () => {
    ...
    const scrollableElement = queryOne(".o_content");
    const table = queryOne(".oi-editor-editable table");
    await hover(".oi-editor-editable td");
