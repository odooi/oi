...
import { click, manuallyDispatchProgrammaticEvent, press, waitFor } from "@oi/hoot-dom";
 ...
 * @param {string} html
 */
export function pasteOiEditorHtml(editor, html) {
    return pasteData(editor, html, "application/vnd.oi.oi-editor");
}
/**
 * @param {Node} node
 */
