...
import { expect, getFixture } from "@oi/hoot";
import { queryOne } from "@oi/hoot-dom";
...
export async function setupWysiwyg(props = {}) {
    ...
    const el = /** @type {HTMLElement} **/ (
        queryOne(`${props.iframe ? ":iframe " : ""}.oi-editor-editable`)
    );
    if (content) {
...
export function insertTestHtml(innerHtml) {
    ...
    container.classList.add("oi-editor-editable");
