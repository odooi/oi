# Part of Oi. See LICENSE file for full copyright and licensing details.
{
    ...
    'version': '1.0',
    'website': 'https://www.odoodooi.com/documentation/master/applications/finance/fiscal_localizations/brazil.html',
...
configure Oi in order to properly use Avatax and send the needed fiscal
