...
from oi.addons.point_of_sale.tests.test_frontend import TestPointOfSaleHttpCommon
from oi.addons.mail.tests.common import mail_new_test_user
from oi.addons.pos_online_payment.tests.online_payment_common import OnlinePaymentCommon
from oi.addons.account.models.account_payment_method import AccountPaymentMethod
from oi.osv.expression import AND
from oi.addons.point_of_sale.tests.common import archive_products
...
class TestUi(TestPointOfSaleHttpCommon, OnlinePaymentCommon):
    ...
    def test_invalid_access_token(self):
        ...
        with mute_logger('oi.http'): # Mutes "The provided order or access token is invalid." online payment portal error.
