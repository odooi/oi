...
from oi.addons.event.tests.common import EventCase
from oi.addons.mail.tests.common import MockEmail
from oi.tests import tagged, users, warmup
...
class TestMailSchedule(EventCase, MockEmail, CronMixinCase):
    ...
    @mute_logger('oi.addons.event.models.event_mail')
    @users('user_eventmanager')
    ...
    @mute_logger(
        'oi.addons.event.models.event_mail',
        'oi.addons.event.models.event_mail_registration',
        'oi.addons.event.models.event_registration',
    )
