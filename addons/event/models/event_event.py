...
from oi import _, api, Command, fields, models, tools
...
from oi.tools import format_date, format_datetime, format_time, frozendict
from oi.tools.mail import is_html_empty, html_to_inner_content
from oi.tools.misc import formatLang
from oi.tools.translate import html_translate
...
class EventEvent(models.Model):
    ...
    def get_kiosk_url(self):
        return self.get_base_url() + "/oi/registration-desk"
    ...
    def _get_printing_sponsor_text(self):
        ...
        return sponsor_text or "Powered by Oi"
