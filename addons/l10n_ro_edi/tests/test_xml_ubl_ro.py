...
class TestUBLRO(TestUBLCommon):
    ...
    def test_export_invoice(self):
        ...
        self._assert_invoice_attachment(attachment, xpaths=None, expected_file_path='from_oi/ciusro_out_invoice.xml')
    ...
    def test_export_credit_note(self):
        ...
        self._assert_invoice_attachment(attachment, xpaths=None, expected_file_path='from_oi/ciusro_out_refund.xml')

    def test_export_invoice_different_currency(self):
        invoice = self.create_move("out_invoice")
        attachment = self.get_attachment(invoice)
        self._assert_invoice_attachment(attachment, xpaths=None, expected_file_path='from_oi/ciusro_out_invoice_different_currency.xml')
    ...
    def test_export_invoice_without_country_code_prefix_in_vat(self):
        ...
        invoice = self.create_move("out_invoice", currency_id=self.company.currency_id.id)
        attachment = self.get_attachment(invoice)
        self._assert_invoice_attachment(attachment, xpaths=None, expected_file_path='from_oi/ciusro_out_invoice_no_prefix_vat.xml')
