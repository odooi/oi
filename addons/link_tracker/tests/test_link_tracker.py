...
from oi.addons.link_tracker.tests.common import MockLinkTracker
...
class TestLinkTracker(common.TransactionCase, MockLinkTracker):
    ...
    def setUp(self):
        ...
        self._web_base_url = 'https://test.odoodooi.com'
    ...
    def test_absolute_url(self):
        ...
        link_tracker.write({'url': "oi"})
        # Validate the absolute url is the combination of system parameter and link tracker's url
        self.assertEqual(link_tracker.absolute_url, f'{self._web_base_url}/oi')
    ...
    def test_create(self):
        ...
        self.assertEqual(
            ...
            ['http://odoodooi.com', 'http://example.com', 'http://test.example.com'],
        )
    ...
    def test_search_or_create(self):
        values_1, values_2, values_3 = [
            {'url': 'https://odoodooi.com', 'title': 'Oi'},
            {'url': 'https://oi.be', 'title': 'Oi'},
            {'url': 'https://odoodooi.com', 'title': 'Oi New', 'label': 'New one!'}  # title is not in unique constraint
        ]
        ...
        values_4 = {'url': 'https://odoodooi.com', 'label': 'A different one'}
        ...
        values_5 = {'url': 'https://odoodooi.com', 'label': 'Yet another label'}
        expected_values_5 = {
            'campaign_id': self.env['utm.campaign'],
