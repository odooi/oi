...
from oi.tests import Form, users, HttpCase, tagged
from oi.addons.hr.tests.common import TestHrCommon
...
class TestHrEmployee(TestHrCommon):
        ...
        user_1, user_2, user_3 = self.env['res.users'].create([
            {
                'name': 'Test User',
                'login': 'test_user',
                'email': 'test_user@odoodooi.com',
            },
            {
                'name': 'Test User 2',
                'login': 'test_user_2',
                'email': 'test_user_2@odoodooi.com',
                'create_employee': True,
            },
            {
                'name': 'Test User 3',
                'login': 'test_user_3',
                'email': 'test_user_3@odoodooi.com',
    ...
    def test_set_user_on_new_employee(self):
        ...
        employee_form.user_id = self.res_users_hr_officer
        with mute_logger('oi.sql_db'), self.assertRaises(UniqueViolation), self.assertRaises(ValidationError), self.cr.savepoint():
            employee_form.save()
