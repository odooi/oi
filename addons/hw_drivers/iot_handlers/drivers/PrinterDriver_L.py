...
from oi.addons.hw_drivers.iot_handlers.interfaces.PrinterInterface_L import PPDs, conn, cups_lock
from oi.addons.hw_drivers.main import iot_devices
from oi.addons.hw_drivers.tools import helpers
from oi.addons.hw_drivers.websocket_client import send_to_controller
...
class PrinterDriver(Driver):
    ...
    def send_status(self):
        """ Sends the current status of the printer to the connected Oi instance.
        """
        self.data = {
            'value': '',
            'state': self.state,
