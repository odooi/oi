...
class Browser:
    ...
    def close_browser(self):
        """close the browser"""
        # Kill browser instance (can't `instance.pkill()` as we can't keep the instance after Oi service restarts)
        # We need to terminate it because Oi will create a new instance each time it is restarted.
