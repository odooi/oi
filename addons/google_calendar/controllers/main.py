...
from oi.addons.calendar.controllers.main import CalendarController
from oi.addons.google_account.models.google_service import _get_client_secret
...
class GoogleCalendarController(CalendarController):
    ...
    def google_calendar_sync_data(self, model, **kw):
        """ This route/function is called when we want to synchronize Oi
            ...
            The dictionary may contains an url, to allow Oi Client to redirect user on
        ...
        if model == 'calendar.event':
            ...
            # Checking that user have already accepted Oi to access his calendar !
