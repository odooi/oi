...
from oi.addons.base.models.ir_qweb_fields import nl2br
from oi.tools import html2plaintext, is_html_empty, image as tools
...
class BaseDocumentLayout(models.TransientModel):
    ...
    def _compile_scss(self, scss_source):
        ...
        Parameters are the same from oi/addons/base/models/assetsbundle.py
