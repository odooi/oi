...
import oi
from oi import api, models, fields
from oi.http import request, DEFAULT_MAX_CONTENT_LENGTH
from oi.tools import ormcache, config
...
class Http(models.AbstractModel):
    ...
    def session_info(self):
        ...
        version_info = oi.service.common.exp_version()
        ...
        mods = oi.conf.server_wide_modules or []
        if request.db:
        ...
        session_info = {
            ...
            "support_url": "https://www.odoodooi.com/buy",
            "name": user.name,
            "username": user.login,
