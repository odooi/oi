...
from oi.http import content_disposition, request
from oi.tools import lazy_property, osutil
from oi.tools.misc import xlsxwriter
...
class ExportFormat(object):
    ...
    def from_data(self, fields, columns_headers, rows):
        """ Conversion method from Oi's export data to whatever the
