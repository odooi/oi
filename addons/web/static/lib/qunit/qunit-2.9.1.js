...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("OiBeforeTestHook", "OiAfterTestHook"); // Oi customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("OiBeforeTestHook"); // Oi customization
