...
/**
 * @typedef {Parameters<typeof import("@oi/owl").mount>[2] & {
 *  className: string | string[];
 *  target?: import("@oi/hoot-dom").Target;
 * }} MountOnFixtureOptions
 *
 * @typedef {{
 *  component: import("@oi/owl").ComponentConstructor;
 *  props: unknown;
 * }} TestRootProps
 */
...
/**
 * @param {App | import("@oi/owl").Component} target
 */
