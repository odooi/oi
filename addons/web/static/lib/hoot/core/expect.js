 ...
 *
 * @typedef {import("@oi/hoot-dom").Dimensions} Dimensions
 * @typedef {import("@oi/hoot-dom").FormatXmlOptions} FormatXmlOptions
 ...
 * @typedef {import("@oi/hoot-dom").QueryRectOptions} QueryRectOptions
 * @typedef {import("@oi/hoot-dom").QueryTextOptions} QueryTextOptions
...
export class Matcher {
     ...
     * @example
     *  expect("header h1").toHaveText(/oi/i);
     */
