...
class BasePreferences {
  ...
  #defaults = Object.freeze({
    ...
    // Oi: don't support scripting (#115302)
    enableScripting: false,
    // Oi: disable stamp editor
    enableStampEditor: false,
    // Oi: open links in new tabs to keep oi document (#84594)
  ...
  try {
    ...
    activeService.renderPages().then(function () {
      ...
      if (activeServiceOnEntry.active) {
        // OI Patch: https://github.com/mozilla/pdf.js/issues/10630#issuecomment-855754913
