import { after, afterEach, beforeEach, registerDebugInfo } from "@oi/hoot";
 ...
 *
 * @param {Partial<OiEnv>} [partialEnv]
 */
 ...
 *  (env: OiEnv, dependencies: Dependencies) => Services[T]
 * } serviceFactory
 */
