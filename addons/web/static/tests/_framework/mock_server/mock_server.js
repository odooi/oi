import { before, createJobScopedGetter, expect, getCurrent, registerDebugInfo } from "@oi/hoot";
import { mockFetch, mockWebSocket } from "@oi/hoot-mock";
...
export class MockServer {
    ...
    /** @type {import("@oi/hoot-mock").ServerWebSocket[]} */
    websockets = [];
    ...
    _findAction(id) {
        ...
        if (!actions.length) {
            throw makeServerError({
                errorName: "oi.addons.web.controllers.action.MissingActionError",
