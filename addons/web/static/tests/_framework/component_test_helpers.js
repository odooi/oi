...
import { queryFirst, queryOne } from "@oi/hoot-dom";
...
/**
 * @typedef {import("@oi/owl").Component} Component
 *
 * @typedef {import("@web/env").OiEnv} OiEnv
 *
 * @typedef {Parameters<typeof import("@oi/owl").mount>[2]} MountOptions
 *
 ...
 * @template [P=any]
 * @template [E=any]
 * @typedef {import("@oi/owl").ComponentConstructor<P, E>} ComponentConstructor
 */
