import { after, expect, getFixture } from "@oi/hoot";
import { click, formatXml, queryAll, queryAllTexts } from "@oi/hoot-dom";
import { animationFrame, Deferred, tick } from "@oi/hoot-mock";
import { Component, onMounted, useSubEnv, xml } from "@oi/owl";
