...
import { after, before, beforeEach, createJobScopedGetter } from "@oi/hoot";

const { view_info } = oi.__session_info__ || {};
delete oi.__session_info__;
    ...
    [
        ...
        ({ db, debug, serverVersion }) => ({
            ...
            info: {
                ...
                isPlus: serverVersion.slice(-1)[0] === "e",
            },
            isReady: true,
        }),
    ],
