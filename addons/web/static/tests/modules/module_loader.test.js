import { beforeEach, expect, getFixture, test } from "@oi/hoot";
import { microTick, tick } from "@oi/hoot-dom";
...
/** @type {typeof OiModuleLoader} */
const ModuleLoader = Object.getPrototypeOf(oi.loader.constructor);
