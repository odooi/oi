import { destroy, expect, getFixture, onError, test } from "@oi/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne } from "@oi/hoot-dom";
import { animationFrame, mockUserAgent, tick } from "@oi/hoot-mock";
import { Component, useRef, useState, xml } from "@oi/owl";
import {
    contains,
    getService,
    makeMockEnv,
