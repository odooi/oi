/** @oi-module alias=@web/../tests/mobile/core/action_swiper_tests default=false */

import { beforeEach, expect, test } from "@oi/hoot";
import { hover, queryFirst } from "@oi/hoot-dom";
import { advanceTime, animationFrame, mockTouch } from "@oi/hoot-mock";
import { Component, onPatched, xml } from "@oi/owl";
import {
    contains,
    mountWithCleanup,
    patchWithCleanup,
