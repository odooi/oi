...
test("escape", () => {
    ...
    expect(escape(`<a href="https://www.odoodooi.com">oi<a>`)).toBe(
        `&lt;a href=&quot;https://www.odoodooi.com&quot;&gt;oi&lt;a&gt;`
    );
    expect(escape(`<a href='https://www.odoodooi.com'>oi<a>`)).toBe(
        `&lt;a href=&#x27;https://www.odoodooi.com&#x27;&gt;oi&lt;a&gt;`
    );
    expect(escape("<a href='https://www.odoodooi.com'>Oi`s website<a>")).toBe(
        `&lt;a href=&#x27;https://www.odoodooi.com&#x27;&gt;Oi&#x60;s website&lt;a&gt;`
    );
});
...
test("escapeRegExp", () => {
    ...
    expect(escapeRegExp("[wowl]")).toBe("\\[wowl\\]");
    expect(escapeRegExp("[wowl.oi]")).toBe("\\[wowl\\.oi\\]");
    expect(escapeRegExp("^oi.define([.]*)$")).toBe("\\^oi\\.define\\(\\[\\.\\]\\*\\)\\$");
    expect(escapeRegExp("[.*+?^${}()|[]\\")).toBe("\\[\\.\\*\\+\\?\\^\\$\\{\\}\\(\\)\\|\\[\\]\\\\");
});
...
test("isEmail", () => {
    ...
    expect(isEmail("test@oi")).toBe(false);
    expect(isEmail("test@oi@odoodooi.com")).toBe(false);
    expect(isEmail("te st@odoodooi.com")).toBe(false);

    expect(isEmail("test@odoodooi.com")).toBe(true);
});
