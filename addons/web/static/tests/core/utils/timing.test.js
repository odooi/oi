import { describe, destroy, expect, getFixture, test } from "@oi/hoot";
import { click, tick } from "@oi/hoot-dom";
import { Deferred, advanceTime, animationFrame, microTick, runAllTimers } from "@oi/hoot-mock";
