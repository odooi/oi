import { destroy, expect, test } from "@oi/hoot";
import { keyDown, keyUp, press, queryAllTexts, queryOne, resize } from "@oi/hoot-dom";
import { animationFrame } from "@oi/hoot-mock";
import { Component, onMounted, useState, xml } from "@oi/owl";
import {
    contains,
    getService,
    makeDialogMockEnv,
