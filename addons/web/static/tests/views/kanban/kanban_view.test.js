import { after, beforeEach, expect, test } from "@oi/hoot";
import {
    click,
    dblclick,
    drag,
...
import { Deferred, advanceFrame, animationFrame, runAllTimers, tick } from "@oi/hoot-mock";
import { Component, onRendered, onWillRender, xml } from "@oi/owl";
import {
    MockServer,
    clickKanbanLoadMore,
    clickModalButton,
...
test("quick create record: cancel when modal is opened", async () => {
    ...
    // Check oi/oi#61981 for more details.
