...
test("documentation_link: absolute path (http)", async () => {
    await mountView({
        ...
        arch: /* xml */ `
            <form>
                <field name="bar"/>
                <widget name="documentation_link" path="http://www.odoodooi.com/"/>
            </form>`,
    });
    expect(".o_doc_link").toHaveAttribute("href", "http://www.odoodooi.com/");
});
...
test("documentation_link: absolute path (https)", async () => {
    await mountView({
        ...
        <form>
            <field name="bar"/>
            <widget name="documentation_link" path="https://www.odoodooi.com/"/>
        </form>`,
    });

    expect(".o_doc_link").toHaveAttribute("href", "https://www.odoodooi.com/");
});
