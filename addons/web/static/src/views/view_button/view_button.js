...
export class ViewButton extends Component {
    ...
    get hasBigTooltip() {
        return Boolean(oi.debug) || this.clickParams.help;
    }
    ...
    getClassName() {
        ...
        if (this.props.className) {
            for (let cls of this.props.className.split(" ")) {
                if (cls in oiToBootstrapClasses) {
                    cls = oiToBootstrapClasses[cls];
                }
                classNames.push(cls);
