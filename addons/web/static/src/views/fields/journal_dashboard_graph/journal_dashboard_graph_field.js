...
import { Component, onWillStart, useEffect, useRef } from "@oi/owl";
...
export class JournalDashboardGraphField extends Component {
    ...
    getLineChartConfig() {
        ...
        const color10 = getColor(3, cookie.get("color_scheme"), "oi");
    ...
    getBarChartConfig() {
        ...
        const color13 = getColor(2, cookie.get("color_scheme"), "oi");
        const color19 = getColor(1, cookie.get("color_scheme"), "oi");
