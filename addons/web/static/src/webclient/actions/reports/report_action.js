...
import { Component, useRef, useSubEnv } from "@oi/owl";
 ...
 * It uses a feature to automatically create links to other oi pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
