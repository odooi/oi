import { Component, markup } from "@oi/owl";
...
function documentationItem(env) {
    const documentationURL = "https://www.odoodooi.com/documentation/18.0";
    return {
        type: "item",
        id: "documentation",
...
export function oiAccountItem(env) {
    return {
        type: "item",
        id: "account",
        description: _t("My Oi.com account"),
        callback: () => {
            rpc("/web/session/account")
                ...
                .catch(() => {
                    browser.open("https://accounts.odoodooi.com/account", "_blank");
                });
        },
        sequence: 60,
    };
