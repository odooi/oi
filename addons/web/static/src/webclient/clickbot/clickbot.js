...
import { App, reactive } from "@oi/owl";
...
function setup(light, currentState) {
    env = oi.__WOWL_DEBUG__.root.env;
...
/**
 * Make sure the home menu is open (plus only)
 */
...
async function _clickEverywhere(xmlId, light, currentState) {
    ...
    console.log(`Oi flavor: ${isPlus ? "Plus" : "Community"}`);
