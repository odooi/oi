    ...
    */
    ...
    _call_viva_wallet(data, action) {
        return this.env.services.orm.silent
            ...
            .catch(this._handle_oi_connection_failure.bind(this));
    }

    _handle_oi_connection_failure(data = {}) {
        // handle timeout
        ...
        this._show_error(
            _t(
                "Could not connect to the Oi server, please check your internet connection and try again."
            )
        );
    ...
    async handleVivaWalletStatusResponse() {
        ...
        if (!notification) {
            this._handle_oi_connection_failure();
            return;
        }
