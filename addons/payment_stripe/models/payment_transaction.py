...
from oi import _, fields, models
...
from oi.addons.payment_stripe import utils as stripe_utils
    ...
    def _stripe_create_customer(self):
        ...
        customer = self.provider_id._stripe_make_request(
            'customers', payload={
                ...
                'description': f'Oi Partner: {self.partner_id.name} (id: {self.partner_id.id})',
