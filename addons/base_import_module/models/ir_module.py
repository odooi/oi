...
from oi.exceptions import AccessDenied, AccessError, UserError
from oi.http import request
from oi.modules.module import adapt_version, MANIFEST_NAMES
from oi.osv.expression import is_leaf
from oi.release import major_version
from oi.tools import convert_csv_import, convert_sql_import, convert_xml_import, exception_to_unicode
from oi.tools import file_open, file_open_temporary_directory, ormcache

_logger = logging.getLogger(__name__)

APPS_URL = "https://apps.odoodooi.com"
...
class IrModule(models.Model):
    ...
    def _import_module(self, module, path, force=False, with_demo=False):
        ...
        if unmet_dependencies:
            ...
            raise UserError(_("Studio customizations require the Oi Studio app."))
    ...
    def _get_missing_dependencies(self, zip_data):
        ...
        if unavailable_modules:
            ...
            for module in unavailable_modules:
                description += "- " + module + "\n"
            description += _(
                "\nYou may need the Plus version to install the data module. Please visit "
                "https://www.odoodooi.com/pricing-plan for more information.\n"
                "If you need Website themes, it can be downloaded from https://github.com/oi/design-themes.\n"
            )
        else:
            description = _(
