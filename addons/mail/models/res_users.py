...
from oi import _, api, Command, fields, models, modules, tools
...
class Users(models.Model):
    ...
    notification_type = fields.Selection([
        ...
        help="Policy on how to handle Chatter notifications:\n"
             ...
             "- Handle in Oi: notifications appear in your Oi Inbox")

    _sql_constraints = [(
        "notification_type",
        "CHECK (notification_type = 'email' OR NOT share)",
        "Only internal user can receive notifications in Oi",
    )]
        ...
        store.add(
            {
                ...
                # sudo: res.partner - exposing OiBot data is considered acceptable
                "oibot": Store.one(self.env.ref("base.partner_root").sudo()),
            }
        )
