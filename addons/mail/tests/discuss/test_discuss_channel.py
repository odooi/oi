...
from oi.addons.mail.models.discuss.discuss_channel import channel_avatar, group_avatar
...
from oi.tests import HttpCase, tagged, users
from oi.tools import html_escape, mute_logger
