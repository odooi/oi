...
from oi.addons.mail.tools import link_preview
...
class TestLinkPreview(MailCommon):
    ...
    def test_link_preview_ignore_internal_link(self):
        ...
        with patch.object(requests.Session, "get", self._patch_with_og_properties), patch.object(
            ...
            urls = [
                ("http://localhost:8069/", "http://localhost:8069/oi", 0),
                ("http://localhost:8069/", "http://localhost:8069/oi/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/web/test", 0),
                ("http://localhost:8069/", "http://localhost:8069/", 1),
                ("http://localhost:8069/", "http://localhost:8069/oi-experience", 1),
                ("http://localhost:8069/", "http://localhost:8069/chat/5/bFtIfYHRco", 0),
                ("https://www.odoodooi.com/", "https://www.odoodooi.com/web", 0),
                ("https://www.odoodooi.com/", "https://www.odoodooi.com/oi", 0),
                ("https://www.odoodooi.com/", "https://www.odoodooi.com/oi/", 0),
                ("https://www.odoodooi.com/", "https://www.odoodooi.com/oi?debug=assets", 0),
                ("https://www.odoodooi.com/", "https://www.odoodooi.com/oi#anchor", 0),
                ("https://www.odoodooi.com/", "https://www.odoodooi.com/oi-experience", 1),
                ("https://www.odoodooi.com/", "https://www.odoodooi.com/oi/1519/tasks/4102866", 0),
                ("http://www.odoodooi.com/", "https://www.odoodooi.com/oi/1519/tasks/4102866", 1),
                ("https://www.odoodooi.com/", "https://wwwaodoodooi.com/oi/", 1),
                ("https://www.odoodooi.com/", "https://www.odoodooi.com/chat/", 0),
                ("https://www.odoodooi.com/", "https://www.odoodooi.com/chat/5/bFtIfYHRco", 0),
                ("http://www.odoodooi.com/", "https://www.odoodooi.com/chat/5/bFtIfYHRco", 1),
                ("https://clients.odoodooi.com/", "https://www.odoodooi.com/oi/1519/tasks/4102866", 1),
                ("https://clients.odoodooi.com/", "https://www.odoodooi.com/chat/5/bFtIfYHRco", 1),
            ]
