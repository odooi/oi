...
from oi.addons.base.models.ir_mail_server import IrMailServer
from oi.addons.base.tests.common import MockSmtplibCase
from oi.addons.bus.models.bus import ImBus, json_dump
from oi.addons.mail.models.mail_mail import MailMail
from oi.addons.mail.models.mail_message import Message
from oi.addons.mail.models.mail_notification import MailNotification
from oi.addons.mail.models.res_users import Users
from oi.addons.mail.tools.discuss import Store
from oi.tests import common, RecordCapturer, new_test_user
from oi.tools import mute_logger
from oi.tools.mail import (
    email_normalize, email_split_and_format_normalize, formataddr
)
from oi.tools.translate import code_translations
...
class MailCommon(common.TransactionCase, MailCase):
    ...
    def _activate_multi_lang(cls, lang_code='es_ES', layout_arch_db=None, test_record=False, test_template=False):
        ...
        with mute_logger("oi.addons.base.models.ir_module", "oi.tools.translate"):
