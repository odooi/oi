...
/**
 * @return {Promise<{ SfuClient: import("@mail/../lib/oi_sfu/oi_sfu").SfuClient, SFU_CLIENT_STATE: import("@mail/../lib/oi_sfu/oi_sfu").SFU_CLIENT_STATE }>}
 */
const loadSfuAssets = memoize(async () => await loadBundle("mail.assets_oi_sfu"));
...
export class Rtc extends Record {
    ...
    async _loadSfu() {
        const load = async () => {
            await loadSfuAssets();
            const sfuModule = oi.loader.modules.get("@mail/../lib/oi_sfu/oi_sfu");
