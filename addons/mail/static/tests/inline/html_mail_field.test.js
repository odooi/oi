...
import { after, before, beforeEach, expect, test } from "@oi/hoot";
import { press, queryOne } from "@oi/hoot-dom";
import { animationFrame, enableTransitions } from "@oi/hoot-mock";
import {
    contains,
    defineModels,
    fields,
...
test("HtmlMail save inline html", async function () {
    ...
    await press("enter");
    expect(".oi-editor-editable").toHaveInnerHTML("<h1> first </h1>");
