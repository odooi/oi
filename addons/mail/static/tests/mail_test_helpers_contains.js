/** @oi-module alias=@web/../tests/utils default=false */

import { __debug__, after, afterEach, expect, getFixture } from "@oi/hoot";
import { queryAll, queryFirst } from "@oi/hoot-dom";
 ...
 *  element.
 * @property {HTMLElement|OiEnv} [target=getFixture()]
...
class Contains {
    ...
    constructor(selector, options = {}) {
        ...
        if (this.options.target?.testEnv) {
            // when OiEnv, special key `target`. See @start
