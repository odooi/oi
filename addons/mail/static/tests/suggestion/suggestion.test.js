...
import { beforeEach, describe, test } from "@oi/hoot";
...
test('display partner mention suggestions on typing "@"', async () => {
    ...
    const partnerId_2 = pyEnv["res.partner"].create({
        email: "testpartner2@odoodooi.com",
        name: "TestPartner2",
    });
...
test("can @user in restricted (group_public_id) channels", async () => {
    ...
    const [partnerId_1, partnerId_2] = pyEnv["res.partner"].create([
        { email: "testpartner1@odoodooi.com", name: "TestPartner1" },
        { email: "testpartner2@odoodooi.com", name: "TestPartner2" },
    ]);
