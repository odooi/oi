/** @oi-module alias=@mail/../tests/helpers/mock_server/models/res_users default=false */
    ...
    _mockResUsers__init_store_data() {
        const res = {
            Store: {
                ...
                oibot: this._mockResPartnerMailPartnerFormat(this.oibotId).get(this.oibotId),
            },
        };
