...
import { Deferred, animationFrame, tick } from "@oi/hoot-mock";
import {
    Command,
    getService,
    onRpc,
...
import { queryFirst } from "@oi/hoot-dom";
...
test("add an emoji after a partner mention", async () => {
    ...
    const partnerId = pyEnv["res.partner"].create({
        email: "testpartner@odoodooi.com",
        name: "TestPartner",
    });
    const channelId = pyEnv["discuss.channel"].create({
        name: "Mario Party",
...
test("Show recipient list when there is more than 5 followers.", async () => {
    ...
    const partnerIds = pyEnv["res.partner"].create([
        { name: "test name 1", email: "test1@odoodooi.com" },
        { name: "test name 2", email: "test2@odoodooi.com" },
        { name: "test name 3", email: "test3@odoodooi.com" },
        { name: "test name 4", email: "test4@odoodooi.com" },
        { name: "test name 5", email: "test5@odoodooi.com" },
        { name: "test name 6", email: "test6@odoodooi.com" },
    ]);
    ...
    await contains("li", { text: "test1@odoodooi.com" });
    await contains("li", { text: "test2@odoodooi.com" });
    await contains("li", { text: "test3@odoodooi.com" });
    await contains("li", { text: "test4@odoodooi.com" });
    await contains("li", { text: "test5@odoodooi.com" });
    await contains("li", { text: "test6@odoodooi.com" });
...
test("Show 'No recipient found.' with 0 followers.", async () => {
    const pyEnv = await startServer();
    const partnerId = pyEnv["res.partner"].create({ name: "test name 1", email: "test1@odoodooi.com" });
    await start();
