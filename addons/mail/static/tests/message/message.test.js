...
import { leave, press, queryFirst } from "@oi/hoot-dom";
...
test("Update the link previews when a message is edited", async () => {
    ...
    await click(".o-mail-Message [title='Expand']");
    await click(".o-mail-Message-moreMenu [title='Edit']");
    await insertText(".o-mail-Message .o-mail-Composer-input", "http://odoodooi.com", {
        replace: true,
    });
    await click(".o-mail-Message a", { text: "save" });
    await contains(".o-mail-Message-body", { text: "http://odoodooi.com" });
...
test("Show email_from of message without author for email message", async () => {
    ...
    await start();
    await openFormView("res.partner", serverState.partnerId);
    await contains(".o-mail-Message-author", { text: "md@odoodooi.company.fr" });
});
