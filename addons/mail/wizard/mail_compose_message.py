...
from oi import _, api, fields, models, Command, tools
from oi.exceptions import UserError, ValidationError
from oi.osv import expression
from oi.tools.mail import is_html_empty, email_normalize, email_split_and_format
from oi.addons.mail.tools.parser import parse_res_ids
...
class MailComposer(models.TransientModel):
    ...
    def _evaluate_res_domain(self):
        ...
        :return: an Oi domain (list of leaves) """
        self.ensure_one()
