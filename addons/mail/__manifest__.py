...
Communicate with your colleagues/customers/guest within Oi.
...
from Oi itself, and that too with great possibilities. For example,
...
these accounts will be automatically downloaded into your Oi system. All
POP3/IMAP-compatible servers are supported, included those that require an
encrypted SSL/TLS connection.
This can be used to easily create email-based workflows for many email-enabled Oi documents, such as:
----------------------------------------------------------------------------------------------------------
...
mailbox-to-Oi integration. Even better: these documents directly act as mini
conversations synchronized by email. You can reply from within Oi, and the
...
(technically: Server Actions) to be triggered for each incoming mail.
    ...
    'assets': {
        ...
        'mail.assets_oi_sfu': [
            'mail/static/lib/oi_sfu/oi_sfu.js',
        ],
        'mail.assets_lamejs': [
        ...
        'mail.assets_public': [
            ...
            'web/static/lib/oi_ui_icons/style.css',
