...
import oi.tests
from oi.tools import html2plaintext

from oi.addons.website.tools import MockRequest
from oi.addons.website_hr_recruitment.controllers.main import WebsiteHrRecruitment

@oi.tests.tagged('post_install', '-at_install')
class TestWebsiteHrRecruitmentForm(oi.tests.HttpCase):
    def test_tour(self):
        ...
        with oi.tests.RecordCapturer(self.env['hr.applicant'], []) as capt:
