...
from oi.addons.payment_worldline.controllers.main import WorldlineController
from oi.addons.payment_worldline.tests.common import WorldlineCommon


@tagged('post_install', '-at_install')
class WorldlineTest(WorldlineCommon, PaymentHttpCommon):

    @mute_logger('oi.addons.payment_worldline.controllers.main')
    def _webhook_notification_flow(self, payload):
        ...
        with patch(
            'oi.addons.payment_worldline.controllers.main.WorldlineController'
