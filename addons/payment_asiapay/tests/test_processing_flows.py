...
from oi.addons.payment_asiapay.controllers.main import AsiaPayController
from oi.addons.payment_asiapay.tests.common import AsiaPayCommon


@tagged('post_install', '-at_install')
class TestProcessingFlows(AsiaPayCommon, PaymentHttpCommon):

    @mute_logger('oi.addons.payment_asiapay.controllers.main')
    def test_webhook_notification_triggers_processing(self):
        ...
        with patch(
            'oi.addons.payment_asiapay.controllers.main.AsiaPayController.'
