...
from oi.addons.payment_mollie.controllers.main import MollieController
from oi.addons.payment_mollie.tests.common import MollieCommon
...
class MollieTest(MollieCommon, PaymentHttpCommon):
    ...
    @mute_logger(
        'oi.addons.payment_mollie.controllers.main',
        'oi.addons.payment_mollie.models.payment_transaction',
    )
    def test_webhook_notification_confirms_transaction(self):
        ...
        with patch(
            'oi.addons.payment_mollie.models.payment_provider.PaymentProvider'
